...
<div class="grid">
    <div class="inp_wrap">
        <label for="f4" class="blind">답변 제목</label>
        <div class="inp_ele">
            <div class="input"><input type="text" name="qa_subject" value="" id="qa_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="제목"></div>
        </div>
    </div>
    <div class="inp_wrap">
        <label for="f6" class="blind">답변 내용</label>
        <div class="inp_ele">
    ...
    <div class="btn_group two">
        <button type="submit" value="답변쓰기" id="btn_submit" accesskey="s" class="btn big green"><span>답변쓰기</span></button>
    </div>
</div>
</form>
