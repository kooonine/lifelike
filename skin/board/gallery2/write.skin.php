				...
				<div class="grid write-grid" id="gridContent">
					...
					<? if ($is_admin) { ?>
						<div class="inp_wrap">
							...
							<div class="inp_ele">
								<div class="input"><input type="text" placeholder="요약설명" id="wr_3" name ="wr_3" value="<?=$wr_3?>">
								</div>
							</div>
						</div>
					<? } ?>
					...
					<div class="write-bottom">
						<div class="row">
							...
							<span class="btn_file" style="float: right;">
								...
								<input type="file" title="파일 업로드" onchange="getCmaFileInfo(this)" id="bf_file" name = "bf_file[]" accept="image/*" >
