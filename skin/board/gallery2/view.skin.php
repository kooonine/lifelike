					...
					<li>
						<? if($board['bo_use_name']!=3){ ?>
							<div class="user-info">
								...
								<span class="user-name"><?=$view['name'] ?></span>
							</div>
						<? } ?>
						<span class="subsubject">
							<?php echo ($board['bo_use_view'] == '1' || $board['bo_use_view_summary'] == '1')?$view['wr_3']:'' ?>
						</span>
							...
							for($i=0; $i<count($itemList); $i++){
								...
								<li class="swiper-slide">
									<a href="<?=$link_url?>">
										...
										<div class="cont">
											<div class="inner">
												<strong class="title bold line2">
													<?=mb_substr($row2['it_name'], 0, 32, 'utf8')."..."?>
												</strong>
