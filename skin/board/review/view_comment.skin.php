...
<div class="grid">
	...
	<div class="tab_cont_wrap">
        ...
        <div class="tab">
            <ul class="type2 tab_btn">
                <li <?php if($comment_order == "wr_datetime, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $wr_id?>&comment_order=wr_datetime"><span>등록순</span></a></li>
                <li <?php if($comment_order == "wr_good desc, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $wr_id?>&comment_order=wr_good desc"><span>추천순</span></a></li>
            </ul>
        </div>
		<div class="tab_cont" >
        					...
        					<li id="c_<?php echo $comment_id ?>">
        						<div class="comment_box">
        							...
        							<div class="btn_comm">                                
                                        ...
                                        <!--         <?php if ($list[$i]['is_edit']) { ?><a href="<?php echo $c_edit_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;"><button type="button" class="btn small">수정</button></a><?php } ?>
                                                <?php if ($list[$i]['is_del'])  { ?><a href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();"><button type="button" class="btn small">삭제</button></a><?php } ?> -->
                                            <?php } ?>
                                            <!-- 찜 눌르면 class="on" 추가 -->
                                            <?php 
                							...
                							?>
                                            <button type="button" class="pick ico <?php if ($pickYN2['bg_flag']) echo 'on';?>" id = "<?php echo $list[$i]['wr_id']?>" name="btn_pick2" href="./good.php?bo_table=review&wr_id=<?php echo $list[$i]['wr_id']?>&good=good&comment=1"><span class="blind">찜</span><?php echo $list[$i]['wr_good']?></button>
                                        </div>
                                    </div>
                                    <div id="edit_<?php echo $comment_id ?>" class="btn small"></div><!-- 수정 -->
            						<div id="reply_<?php echo $comment_id ?>" class="btn small"></div><!-- 답변 -->
        						</div>
        					</li>
            			<?php }else{ ?>
            		    	<li id="c_<?php echo $comment_id ?>">
	...
	<div class="btn_group"><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $wr_id?>&limit_count=<?php echo $limit_count+$board['bo_reply_rows'];?>" class="btn big border"><span>더보기</span></a></div>
	<?php }?>
</div>
