...
<div>
    ...
    <div class="form_01">
        ...
        <li class="rgs_name_li">
            ...
            if($config['cf_cert_use']) {
                ...
                if($config['cf_cert_hp'])
                    echo '<button type="button" id="win_hp_cert" class="btn_frmline btn">휴대전화 본인확인</button>'.PHP_EOL;
            ...
            <span class="frm_info">아이핀 본인확인 후에는 이름이 자동 입력되고 휴대전화 본인확인 후에는 이름과 휴대전화번호가 자동 입력되어 수동으로 입력할수 없게 됩니다.</span>
            <?php } ?>
            <div id="msg_certify">
        ...
        <li>
            <label for="reg_mb_tel" class="sound_only">연락처<?php if ($config['cf_req_tel']) { ?><strong>필수</strong><?php } ?></label>
        ...
        <li>
            <label for="reg_mb_hp" class="sound_only">휴대전화번호<?php if ($config['cf_req_hp']) { ?><strong>필수</strong><?php } ?></label>

            <input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input full_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20" placeholder="휴대전화번호">
        ...
        $("#win_hp_cert").click(function(e) {
            ...
            switch($config['cf_cert_hp']) {
                ...
                case 'lg':
                    ...
                    break;
                default:
                    echo 'alert("기본환경설정에서 휴대전화 본인확인 설정을 해주십시오");';
                    echo 'return false;';
                    break;
            }
            ?>
