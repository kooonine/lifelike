...
function price_calculate() {
    ...
    if(isNaN(it_price))
        return;
    */
    var $el_it_price = $("input.it_price");

    var $el_prc = $("input.io_price");
    var $el_qty = $("input[name^=ct_qty]");
    var $el_type = $("input[name^=io_type]");
    var it_price, price, type, qty, total = 0;
    ...
    $("#sit_tot_price").empty().html("<em>" + number_format(String(total)) + " 원</em>");

    if ($("#sit_tot_price2") != null) $("#sit_tot_price2").empty().html("<strong class=\"price\"><em>" + number_format((total * parseInt($("#sit_tot_price2").attr("month")))) + " 원</em></strong>");
}
