...
function thumbnail($filename, $source_path, $target_path, $thumb_width, $thumb_height, $is_create, $is_crop=false, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3')
{
    ...
    // cdn 에도 저장 !!!
    // 
    ftp://litandard@litandard-org.daouidc.com:2021/data/item
    sftp://lifelike2@lifelike.co.kr/home/hosting_users/lifelike2/www/data/item
    // "/var/www/html/data/file/itemuse/thumb-2887057409_HtvmlpXs_27199414b46562f624456a8f7738fb8d7bfd444a_172x172.jpg"
    //  when gkwlaks rhscost
    // qbhxhdsk fldspdy 
    // $dest_file2 = G5_DATA_PATH .'/file/itemuse/ /';
    $fileOri = $thumb_file;
    $dest_file =str_replace('/var/www/html','',$fileOri);
    ...
    $upload = ftp_put($conn_id, $dest_file, $fileOri, FTP_BINARY);


    // ?
    // return 'test : '.($thumb_file);
