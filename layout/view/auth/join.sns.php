...
<form id="formPassInfo" action="/auth/join.form.php" method="POST">
    ...
    <input type="hidden" name="mb_id" value="<?php echo $user_id; ?>">
    <input type="hidden" name="mb_email" value="<?php echo isset($user_email) ? $user_email : ''; ?>">
    <input type="hidden" name="appleCheck" value=<?= $provider?>>
    <input type="hidden" name="appleId" value=<?= $ecode?>>
