...
class Hybrid_Providers_Apple extends Hybrid_Provider_Model_OAuth2
{
    ...
    function initialize()
    {
        ...
        $this->api->api_base_url  = "https://appleid.apple.com/auth/authorize";
        $this->api->authorize_url = "https://appleid.apple.com/auth/authorize";
        $this->api->token_url     = "https://appleid.apple.com/auth/authorize";
    ...
    */
    ...
    {
        // $params = array('property_keys' => 'kaccount_email'); // v1 만료됨 - 200515 balance@panpacific.co.kr
        $params = array('property_keys' => array('kakao_account' => array('email')));
    ...
    private function authenticate($code)
    {
        $params = array(
            ...
            "scope" => 'email',
            "redirectURI" => 'https://lifelike.co.kr/appleCallback',
            "state" => 'DE'
            );
