...
$LGD_BUYERSSN               = '000000';                  // 주민등록번호 (보안을 위해 DB나 세션에서 가져오세요)
                                                                // 휴대전화 본인인증을 사용할 경우 주민번호는 '0' 13자리를 넘기세요. 예)0000000000000
...
$payReqMap['LGD_HOLDCHECKYN']           = $LGD_HOLDCHECKYN;           			// 휴대전화본인확인 SMS발송 여부
...
<div id="uplus_win" class="new_win mbskin">
    <h1 id="win_title">휴대전화 본인확인</h1>
    <p class="up_cmt"><img src="<?php echo G5_LGXPAY_URL; ?>/img/upluslogo.jpg" alt="">LG유플러스에 휴대전화 본인확인 요청 중입니다.</p>
    <div class="up_info">
