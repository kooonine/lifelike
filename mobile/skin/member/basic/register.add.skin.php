...
<script>
	...
	header += '<h1 class="title"><span>추가 정보 입력</span></h1>';
	header += '<a href="<?php echo G5_MOBILE_URL ?>/common/register_select.php" class="btn_back"><span class="blind">뒤로가기</span></a>';
...
<div class="content comm sub">
	...
	<div class="grid">
		<div class="title_bar">
			<h2 class="g_title_01">프로필 등록<span class="txt_essential"><em>필수 입력 사항</em></span></h2>
		</div>
		<form id="frm_member" name="frm_member" action="<?php echo $register_action_url ?>" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="inp_wrap">
				<div class="title count9"><label for="join1">닉네임 입력<span class="txt_essential"><em>필수 입력 사항</em></span></label></div>
			...
			<div class="inp_wrap">
				<div class="title count3">
					<label for="join7">주소(기본 배송지)<span class="txt_essential"><em>필수 입력 사항</em></span></label>
				</div>
				<div class="inp_ele count6 r_btn_100">
					<div class="input"><input type="text" placeholder="" id="mb_zip" name="mb_zip" title="우편번호" readonly value="<?php echo $mb['mb_zip1'] . $mb['mb_zip2'] ?>"></div>
			...
			<input type="hidden" id="mb_addr3" name="mb_addr3" value="<?php echo $mb['mb_addr_jibeon'] ?>">
			<input type="hidden" id="mb_addr_jibeon" name="mb_addr_jibeon" value="<?php echo $mb['mb_addr3'] ?>">
			...
			<div class="inp_wrap">
				...
				<div class="inp_ele count6">
					...
					<span class="cmt">추천인 아이디 입력 시 추천인과 본인에게 적립금 <strong><?php echo $config['cf_recommend_point']; ?>원씩</strong> 드립니다. <br>(추천인의 아이디를 정확히 입력해 주세요.)</span>
				</div>
