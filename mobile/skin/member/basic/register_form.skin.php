...
<script>
    ...
    header += '<h1 class="title"><span>회원정보수정</span></h1>';
    header += '<a href="<?= G5_SHOP_URL ?>/mypage.php" class="btn_back"><span class="blind">뒤로가기</span></a>';
        ...
        <div class="user_info">
            ...
            <div class="inner">
                ...
                <div class="edit_cont">
                    ...
                    <a href="#" class="name" id="a_nick"><strong><?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : $member['mb_name']; ?></strong></a>
                    ...
                    <?php } else {  ?>
                        ...
                        <input type="text" hidden style="background-color: #ffFFFF;font-size: 20pt;width: 180px;" name="mb_nick" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>" id="reg_mb_nick" maxlength="20" placeholder="닉네임">
        ...
        <div class="grid bg_none">
            ...
            <div class="border_box">
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input">
                            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" minlength="3" maxlength="20" readonly placeholder="아이디">
                        </div>
                    </div>
                </div>
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input">
                            <input type="text" name="mb_name" value="<?php echo $member['mb_name'] ?>" id="reg_mb_name" readonly placeholder="아이디">
                        </div>
                    </div>
                </div>
                <div class="inp_wrap">
            ...
            <div class="border_box">
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input">
                            <input type="password" name="mb_password_org" id="mb_password_org" minlength="8" maxlength="15" placeholder="현재 비밀번호 입력">
                        </div>
                    </div>
                </div>
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input">
                            <input type="password" name="mb_password" id="reg_mb_password" minlength="8" maxlength="15" placeholder="영문,숫자,특수문자,조합 8~16자">
                        </div>
                    </div>
                </div>
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input">
                            <input type="password" name="mb_password_re" id="reg_mb_password_re" minlength="8" maxlength="15" placeholder="새 비밀번호 재입력">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border_box">
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6 r_btn_100">
                        <div class="input"><input type="tel" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" required maxlength="20" placeholder="휴대전화 번호 입력"></div>
                ...
                <div class="inp_wrap">
                    ...
                    <div class="inp_ele count6">
                        <div class="input"><input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" maxlength="20" placeholder="전화번호"></div>
                    </div>
                </div>
            </div>
            <div class="title_bar">
            ...
            <div class="border_box">
                        ...
                        <span class="sel_box">
                            <select name="year" id="year" title="목록" target1="month" target2="day">
                                ...
                                foreach (range(date('Y'), 1900) as $val) {
                                    if ($mb_birth_explode[0] == $val) $selected = 'selected';
                                    else $selected = '';
                        ...
                        <span class="sel_box">
                            <select name="month" id="month" title="목록" target1="year" target2="day">
                                ...
                                foreach (range(1, 12) as $val) {
                                    if ($mb_birth_explode[1] == $val) $selected = 'selected';
                                    else $selected = '';
                        ...
                        <span class="sel_box">
                            <select name="day" id="day" title="목록">
                                ...
                                foreach (range(1, 31) as $val) {
                                    if ($mb_birth_explode[2] == $val) $selected = 'selected';
                                    else $selected = '';
                ...
                <div class="title_bar">
                    ...
                    <a href="<?php echo G5_SHOP_URL ?>/orderaddress.php" id="order_address1"><button class="btn green_line round floatR"><span>배송지 관리</span></button></a>
                    <script>
                        $(function() {
                            // 배송지목록
                ...
                <div class="border_box">
                    <div class="inp_wrap">
                        <div class="inp_ele count9 r_btn_100">
            ...
            $("#btn_send_auth_key").click(function(e) {
                ...
                $.post(
                    "<?php echo $register_auth_url; ?>", {
                        name: encodeURIComponent($('#reg_mb_name').val()),
                        auth_phoneNumber: $('#reg_mb_hp').val()
                    },
                    function(data) {
                        if (data.result == 'S') {
