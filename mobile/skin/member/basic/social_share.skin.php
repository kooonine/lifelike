...
<body>
	<section class="popup_container layer">
    	<div class="inner_layer">
    		...
    		<div class="grid">
    			...
    			<ul class="sns_link">						
                    ...
                    <li><a href="#" class="sns talk" onclick="sendLink('<?php echo $share_url;?>&wr_id=<?php echo $wr_id?>')"> <span>카카오톡으로 공유하기</span> </a></li>
                    <li><a href="#" class="sns facebook" onclick="sendSns('facebook','<?php echo $share_url;?>','')"> <span>페이스북으로 공유하기</span> </a></li>
    			</ul>
    			<a href="#" class="btn_closed" onclick="window.close();"><span class="blind">닫기</span></a>
    		</div>
    	</div>
    </section>
		<!-- //popup -->
		...
		function sendLink(url) {
			var wr_2 = '<?php echo $wr_2?>'.replace('-','#');
		...
		function sendSns(sns, url, txt)
		{
		    ...
		    switch(sns)
		    {
		        ...
		        case 'naver':
		            o = {
		                method:'popup',
		                url:'https://share.naver.com/web/shareView.nhn?url=' +_url + "&title=" + '게시글 공유'
		            };
		            break;
