...
<div class="content join sub">
	...
	<form id = "frm_member" name ="frm_member" action="<?=$register_action_url ?>" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off" enctype='multipart/form-data'>
		<div class="grid">
			...
			<div class="inp_wrap">
				...
				<div class="inp_ele count6 r_btn_100">
					<div class="input"><input type="text" placeholder="사업자등록번호 입력" id="company_no" name = "company_no" required></div>
			...
			<div class="inp_wrap">
				...
				<div class="inp_ele count6">
					<div class="input"><input type="text" placeholder="" id="company_name" name ="company_name" required></div>
				</div>
			</div>
			<div class="inp_wrap">
				<div class="title count3"><label for="company_leader">대표자명</label></div>
				<div class="inp_ele count6">
					<div class="input"><input type="text" placeholder="" id="company_leader" name ="company_leader" required></div>
				</div>
			</div>
			<div class="inp_wrap">
				<div class="title count3"><label for="company_category">업태/종목</label></div>
				<div class="inp_ele count6">
					<div class="input"><input type="text" placeholder="" id="company_category" name ="company_category" required></div>
				</div>
			</div>
			<div class="inp_wrap">
				<div class="title count3"><label for="company_hp">대표 전화번호<br>(회사 연락처)</label></div>
				<div class="inp_ele count6">
					<div class="input"><input type="tel" placeholder="대표 전화번호 입력" id="company_hp" name ="company_hp" required></div>
				</div>
			</div>
			<div class="inp_wrap">
				...
				<div class="inp_ele count6 r_btn_100">
					<div class="input"><input type="tel" placeholder="" id="company_zip" name="company_zip" title="우편번호" onclick="win_zip('frm_member', 'company_zip', 'company_addr1', 'company_addr2', 'company_addr3','company_addr_jibeon');" readonly required /></div>
			...
			<div class="inp_wrap">
				<div class="inp_ele count6 col_r">
					<div class="input"><input type="tel" placeholder="" id="company_addr1"  name = "company_addr1" readonly required></div>
				</div>
			</div>
			<div class="inp_wrap">
				<div class="inp_ele count6 col_r">
					<div class="input"><input type="tel" placeholder="" id="company_addr2" name = "company_addr2" ></div>
				</div>
			</div>
		...
		<div class="grid bg_none">
			<div class="inp_wrap alignR mt20m">
				<p class="floatL bold">사업자등록증 사본 첨부</p>
			</div>
			<div class="btn_group">
				<span class="btn_file">
		...
		<div class="grid">
			<div class="inp_wrap">
				...
				<div class="inp_ele count6 r_btn_80">
					<div class="input">
						<input type="text" placeholder="아이디 입력" id="mb_id" name ="mb_id" required>
					</div>
			...
			<div class="essential">
				<div class="inp_wrap">
					<span class="chk check">
						...
						<label for="chk_01">서비스 이용 약관<span>(필수)</span></label>
					</span>
					<a href="<?=G5_MOBILE_URL?>/common/terms_agreement.php?id=agree_01&type=stipulation" class="btn floatR arrow_r_green">전문보기</a>
				</div>
				<div class="inp_wrap">
					<span class="chk check">
						<input type="checkbox" id="agree_02" name="agree_02">
						<label for="chk_02">개인정보 수집 동의<span>(필수)</span></label>
					</span>
					<a href="<?=G5_MOBILE_URL?>/common/terms_agreement.php?id=agree_02&type=user_privacy&title=개인정보 수집" class="btn floatR arrow_r_green">전문보기</a>
				</div>
				<div class="inp_wrap">
					<span class="chk check">
						<input type="checkbox" id="agree_03" name="agree_03">
						<label for="chk_03">마케팅 정보 활용 동의<span>(선택)</span></label>
					</span>
					<a href="<?=G5_MOBILE_URL?>/common/terms_agreement.php?id=agree_03&type=collection_privacy&title=마케팅 정보 활용" class="btn floatR arrow_r_green" >전문보기</a>
				</div>
			...
			<div class="inp_wrap mt20m">
				<span class="cmt">라이프라이크 이용약관 및 개인정보 동의 내용을 확인하였으며, 위 내용에 동의합니다. </span>
			</div>
...
<script>
	...
	jQuery(function($){
		...
		$(document).on("click", "#file_delete", function() {
			...
			if(result){
				$("#company_file").replaceWith($("#company_file").val('').clone(true));
				$('#file_list').html('');
			}
		});
