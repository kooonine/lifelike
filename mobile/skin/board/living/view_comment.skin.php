...
<div class="grid">
	...
	<div class="tab_cont_wrap">
        ...
        <div class="tab">
            <ul class="type2 tab_btn">
                <li <?php if($comment_order == "wr_datetime, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=living&wr_id=<?php echo $wr_id?>&comment_order=wr_datetime"><span>등록순</span></a></li>
                <li <?php if($comment_order == "wr_good desc, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=living&wr_id=<?php echo $wr_id?>&comment_order=wr_good desc"><span>추천순</span></a></li>
            </ul>
        </div>
		<div class="tab_cont" >
        						...
        						<div class="comment_box">
        							...
        							<div class="btn_comm">                                
                                        ...
                                        <div class="btn_comm_row">
                							...
                							?>
                                            <button type="button" class="pick ico <?php if ($pickYN2['bg_flag']) echo 'on';?>" id = "<?php echo $list[$i]['wr_id']?>" name="btn_pick2" href="./good.php?bo_table=living&wr_id=<?php echo $list[$i]['wr_id']?>&good=good&comment=1"><span class="blind">찜</span><?php echo $list[$i]['wr_good']?></button>
	...
	<div class="btn_group"><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=living&wr_id=<?php echo $wr_id?>&limit_count=<?php echo $limit_count+$board['bo_reply_rows'];?>" class="btn big border"><span>더보기</span></a></div>
	<?php }?>
</div>
