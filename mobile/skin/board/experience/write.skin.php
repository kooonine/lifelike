...
header += '<h1 class="title"><span>체험단 신청</span></h1>';
...
?>
		<div class="inp_wrap">
            <div class="title count3"><label for="">이름<span class="txt_essential"><em>필수입력</em></span></label></div>
...
?>
		<div class="inp_wrap">
            <div class="title count3"><label for="">이메일주소<span class="txt_essential"><em>필수입력</em></span></label></div>
            <div class="inp_ele count6">
...
?>
        ...
        <div class="inp_wrap">
            ...
            <a href="<?php echo G5_MOBILE_URL?>/common/terms_agreement.php?id=chk_01&type=user_privacy" class="btn floatR arrow_r" target="_blank">전문보기</a>
        </div>
		...
		<div class="btn_group"><button type="submit" id="btn_submit" class="btn big green"><span>체험단 신청</span></button></div>
...
function fviewcomment_submit(f)
{
	...
	contentJson.name = $('#mb_name').val();
	contentJson.email = $('#mb_email').val();
	contentJson.phone = $('#mb_hp').val();
