...
header += '<h1 class="title"><span>"<?php echo $board['bo_subject']; ?>" 작성</span></h1>';
...
<div class="content community type3 sub">
	...
	<div class="grid" id="gridContent">
        ...
        <!-- 분류 선택시 f_200.30.001_m.html 팝업 -->
            ...
            <?php if($board['bo_use_grade'] == "1"){ ?>
            <div class="star-point" >
				<p class="text">별점을 선택 해 주세요.</p>
               <div class="star">
                	<input type="hidden" name="wr_8" id="wr_8" value="<?php echo $wr_8?>">
                    <ul class="select_star">
                        <li class="<?php echo ($is_score>=2)?'on':'';?>"><button type="button" onclick="$('#wr_8').val('2');"><span class="blind">1점</span></button></li>
                        <li class="<?php echo ($is_score>=4)?'on':'';?>"><button type="button" onclick="$('#wr_8').val('4');"><span class="blind">2점</span></button></li>
                        <li class="<?php echo ($is_score>=6)?'on':'';?>"><button type="button" onclick="$('#wr_8').val('6');"><span class="blind">3점</span></button></li>
                        <li class="<?php echo ($is_score>=8)?'on':'';?>"><button type="button" onclick="$('#wr_8').val('8');"><span class="blind">4점</span></button></li>
                        <li class="<?php echo ($is_score>=10)?'on':'';?>"><button type="button" onclick="$('#wr_8').val('10');"><span class="blind">5점</span></button></li>
                    </ul>
                </div>
            </div>
            <?php } ?>
		...
		<?php if ($is_admin) { ?>			
		<div class="inp_wrap">
            <label class="blind">요약설명</label>
            <div class="inp_ele">
                <div class="input"><input type="text" placeholder="요약설명" id="wr_3" name ="wr_3" value="<?php echo $wr_3?>">
                </div>
            </div>
		</div>
		<?php } ?>
...
$(document).ready(function(){
	...
	$(document).on("click", ".btnSearch", function() {
        ...
        $.post(
        		"<?php echo G5_SHOP_URL?>/ajax.m.itemlist.php",
