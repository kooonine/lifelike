...
<div class="grid">
	<?php 
        if($w == '')
            $w = 'c';
    ?>
	<h3 class="blind"><a name="comment">댓글 등록</a></h3>
	<div id="bo_vc_w">
    	...
    	<div class="inp_ele r_btn comment_write">
    		<div class="input">
        ...
        <div class="inp_ele r_btn comment_write">
            <div class="input">
                <label for="comment_write" class="blind">댓글</label>
                <input type="text" id="wr_content" name="wr_content" placeholder="로그인 후 작성하실 수 있습니다." class="readonly" readonly="readonly">
            </div>
            <button type="button" class="btn green" disabled="disabled">등록</button>
        </div>
        <?php } ?>
	</div>
	...
	<div class="tab_cont_wrap">
        ...
        <div class="tab">
            <ul class="type2 tab_btn">
                <li <?php if($comment_order == "wr_comment desc, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $wr_id?>&comment_order=wr_comment desc#comment"><span>등록순</span></a></li>
                <li <?php if($comment_order == "wr_good desc, ") {?>class="on"<?php }?> ><a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $wr_id?>&comment_order=wr_good desc#comment"><span>추천순</span></a></li>
            </ul>
        </div>
		<div class="tab_cont" >
        						...
        						<div class="comment_box">
        							...
        							<div class="btn_comm">                                
                                        ...
                                        <div class="btn_comm_row">
                							...
                							?>
                                            <button type="button" class="pick ico <?php if ($pickYN2['bg_flag']) echo 'on';?>" id = "<?php echo $list[$i]['wr_id']?>" name="btn_pick2" href="./good.php?bo_table=<?php echo $board['bo_table']?>&wr_id=<?php echo $list[$i]['wr_id']?>&good=good&comment=1"><span class="blind">찜</span><?php echo $list[$i]['wr_good']?></button>
...
<?php include_once(G5_BBS_PATH.'/view_comment.report.php'); ?>
