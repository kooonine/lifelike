...
header += '<h1 class="title"><span>체험단 리뷰</span></h1>';
			...
			<div class="content sub community type3">
				...
				<div class="grid head new-grid">
					...
					<div class="star-point">
                        ...
                        <div class="star">
                            <!-- width = 평점 2배 -->
                            <div class="star-bar"><span class="bar" style="width:0%;" id="span_star"></span></div>
                        </div>
                        <input type="hidden" id ="wr_8" name= "wr_8" value="<?php echo $view['wr_8']?>">
                    </div>
...
$(document).ready(function(){
	...
	$("#btn_pick").click(function() {
	 ...
	 $.star_create = function (){
		var star_point = $('#wr_8').val();
		if(star_point == ''){
			star_point = 0;
		}else {
			star_point = parseInt(star_point);
		}
		var star_width = star_point*10;
		$('.star-point .num').html(star_point/2);
		if(star_point != 0)
		$("#span_star").css('width',star_width+'%');	
	 };
	$.star_create();
});
