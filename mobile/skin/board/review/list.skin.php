...
<div class="content community type2">
	<!-- 컨텐츠 시작 -->
	<?
	$bannersql = " select * from lt_board where bo_use = 1 and bo_table='review'";
		...
		<div class="card-list">
			<ul>
				...
				for ($i=0; $i<count($list); $i++) {
					...
					<div class="btn_fix"><a href="<?=G5_BBS_URL?>/write.php?bo_table=review"><button type="button" class="btn_fix_write"><span class="blind">글쓰기</span></button></a></div>
				</div>
				<!-- 컨텐츠 종료 -->
			</div>
			<!-- 게시판 목록 끝 -->
