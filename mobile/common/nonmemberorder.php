		...
		<section class="popup_container layer">
			<div class="inner_layer">
				<div id="lnb" class="header_bar">
					<h1 class="title"><span>비회원 주문/배송조회</span></h1>
				...
				<div class="content login">
					...
					<div class="grid cont">
						...
						<div class="title_bar none">
							<h2 class="g_title_01">비회원 구매상품만 조회가 가능합니다.</h2>
							<p class="g_title_02">회원가입하시면 다양한 혜택을 받으실 수 있습니다.</p>
						</div>
					</div>
					<div class="grid">
						<form name="forderinquiry" method="post" action="<?php echo G5_MSHOP_URL . '/orderinquiry.php'; ?>" autocomplete="off">
							<div class="inp_wrap">
