...
?>
        ...
        <div id="container">
                <div class="content content-add">
                    <div class="clearfix service-visual-wrap">
                    ...
                    <div class="washing-content-01 pb50">
                        <div class="inner">
                            ...
                            <div class="table-add-text">
                                ...
                                <ul>
                                    <li class="list-style-none">같은 아이템이더라도 제조 방식이 다를 수 있으며 그에 따른<br>책임소지의 문제가 생길 수 있습니다.<br>따라서 LIFELIKE 제품만 전문적으로 수선하겠습니다.</li>
                                </ul> 
                            </div>
                            <div class="table-add-text">
                                <p>Q 02. 수선이 불가한 경우</p>
                    ...
                    <div class="washing-content-02">
                        <div class="inner">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="washing-table mb65 storage-table right">
                                    ...
                                    <div class="washing-table mb65 storage-table left">
                                ...
                                <div class="table-add-text">
                                    <ul>
                                        <li>위 요금표는 안내를 위한 것으로, 전문 상담사와 통화 후<br><span></span>정확한 요금 안내가 이루어집니다.</li>
                    ...
                    <div class="rental-content-03">
                        <div class="inner">
                            <p class="content-title mb22 title-deco">
                                서비스 프로세스
                            </p>
                            <div class="clearfix">
