...
<?php if ($swiperslide) { ?>
    <div class="swiper-container">
        ...
        for ($i = 0; $od = sql_fetch_array($result); $i++) {
            // 주문상품
            $sql = " select it_name, ct_option, it_id, ct_keep_month, ct_id
            ...
            switch ($od['od_status']) {
                ...
                case '수거박스배송':
                    if ($od['od_boxsend_invoice']) {
                        $url = G5_URL . "/common/tracking.php?invc_co=롯데택배&invc_no={$od['od_boxsend_invoice']}";
                ...
                case '배송완료':
                    ...
                    /*elseif($od['od_type'] == "L" || $od['od_type'] == "S") {
                         $btn_act .= '<button class="btn gray_line small" od_id="'.$od['od_id'].'" uid="'.$uid.'"><span>구매확정</span></button>';
                         }*/
                    break;
                case '구매완료':
                    if ($od['od_type'] == "R" || $od['od_type'] == "O") {
                        ...
                        if ($review['cnt'] <= 0) $btn_act .= '<button class="btn gray_line small" it_id="' . $ct['it_id'] . '" ct_id="' . $ct['ct_id'] . '" od_id="' . $od['od_id'] . '"><span>리뷰작성</span></button>';
                        else $btn_act .= '<button class="btn gray_line small" it_id="' . $ct['it_id'] . '" ct_id="' . $ct['ct_id'] . '" od_id="' . $od['od_id'] . '"><span>리뷰보기</span></button>';
                    }
                    break;
                case '계약등록':
            ...
            <?php if ($swiperslide) { ?><div class="swiper-slide"><?php } ?>
                <div class="order_cont">
                    <div class="head">
                        ...
                        ?>
                        <a href="<?php echo G5_SHOP_URL; ?>/orderinquiryview.php?od_id=<?php echo $od['od_id']; ?>&amp;uid=<?php echo $uid; ?>" class="detail-view">상세보기</a>
                    </div>
                    <div class="body">
                        <div class="order_num">
                            <span class="tit">주문번호 : <a href="<?php echo G5_SHOP_URL; ?>/orderinquiryview.php?od_id=<?php echo $od['od_id']; ?>&amp;uid=<?php echo $uid; ?>"><?php echo $od['od_id']; ?></a></span>
                        </div>
                        <?php if ($od['od_type'] == "O") {
                            //제품
                        ?>
                            <div class="cont">
                                <div class="photo"><a href="./item.php?it_id=<?php echo $ct['it_id']; ?>"><?php echo $image; ?></a></div>
                                <div class="info">
                                    <strong><a href="./item.php?it_id=<?php echo $ct['it_id']; ?>"><?php echo stripslashes($ct_name); ?></a></strong>
                                    <p>옵션 : <?php echo get_text($ct['ct_option']); ?></p>
                                    <p>주문일 : <?php echo substr($od['od_time'], 0, 10); ?></p>
                                    <p class="price"><span>결제 금액 : </span> <?php echo display_price($od['od_receipt_price']); ?> 원</p>
                                </div>
                        ...
                        ?>
                            <div class="cont">
                                ...
                                <div class="info">
                                    <strong><a href="./item.php?it_id=<?php echo $ct['it_id']; ?>"><?php echo stripslashes($ct_name); ?></a></strong>
                                    <p>옵션 : <?php echo get_text($ct['ct_option']); ?></p>
                                    <p>계약기간 : <?php echo number_format($od['rt_month']); ?>개월</p>
                                    <p>계약일 : <?php echo substr($od['od_time'], 0, 10); ?></p>
                                    <p class="price"><span>리스 금액 : </span> <?php echo display_price($od['rt_rental_price']); ?> 원</p>
                                </div>
                                <div class="btn_comm count3" id="orderinquiry_btn">
                                    <?php echo $btn_act; ?>
                                </div>
                            </div>
                        <?php } elseif ($od['od_type'] == "L") {
                            //세탁
                        ?>
                            <div class="cont">
                                <div class="photo"><a href="./item.php?it_id=<?php echo $ct['it_id']; ?>"><?php echo $image; ?></a></div>
                        ...
                        ?>
                            <div class="cont">
                                ...
                                <div class="info">
                                    ...
                                    <p>옵션 : <?php echo get_text($ct['ct_option']); ?></p>
                                    <p>신청일 : <?php echo substr($od['od_time'], 0, 10); ?></p>
                                    <p>보관 기간 : <?php echo $ct['ct_keep_month']; ?>개월</p>
                                    <p class="price"><span>결제 금액 : </span> <?php echo display_price($od['od_receipt_price']); ?> 원</p>
                                </div>
                                <div class="btn_comm count3" id="orderinquiry_btn">
                                    <?php echo $btn_act; ?>
                        ...
                        ?>
                            <div class="cont">
                                ...
                                <div class="info">
                                    ...
                                    <p>옵션 : <?php echo get_text($ct['ct_option']); ?></p>
                                    <p>주문일 : <?php echo substr($od['od_time'], 0, 10); ?></p>
                                    <p class="price"><span>결제 금액 : </span> <?php echo ($od['od_cart_price']) ? display_price($tot_price) . " 원" : "후불"; ?></p>
                                </div>
                                <div class="btn_comm count3" id="orderinquiry_btn">
                                    <?php echo $btn_act; ?>
                                </div>
        ...
        if ($.fn.orderinquiry_btn_click == null) {
            ...
            $.fn.orderinquiry_btn_click = function() {
                ...
                switch (mode) {
           	 	...
           	 	if(href.indexOf("<?php echo G5_URL ?>") >= 0){
                    ...
                    case "교환요청":
                        if (confirm("교환을 요청 하시겠습니까? 교환 시 사유에 따라 배송료가 발생 될 수 있습니다.")) {
                            var uid = $(this).attr("uid");
                            location.href = "<?php echo G5_SHOP_URL; ?>/orderinquirychangeform.php?od_id=" + od_id + "&act=change&uid=" + uid;
                        }
                        break;
                    case "교환철회":
                    ...
                    case "반품요청":
                        if (confirm("반품을 요청 하시겠습니까? 반품 시 사유에 따라 배송료가 발생 될 수 있습니다.")) {
                            var uid = $(this).attr("uid");
                            location.href = "<?php echo G5_SHOP_URL; ?>/orderinquiryreturnform.php?od_id=" + od_id + "&act=return&uid=" + uid;
                        }
                        break;
                    case "반품철회":
                    ...
                    case "위약금납부":
                        var uid = $(this).attr("uid");
                        location.href = "<?php echo G5_SHOP_URL; ?>/orderform.out.php?od_id=" + od_id + "&uid=" + uid;
                        break;
                    case "위약금영수증":
                        var uid = $(this).attr("uid");
                    ...
                    case "수선비용결제":
                        var uid = $(this).attr("uid");
                        location.href = "<?php echo G5_SHOP_URL; ?>/orderform2.php?od_id=" + od_id;
                        break;
                    case "계약서다운로드":
                        url = "<?php echo G5_SHOP_URL; ?>/orderinquiryview.rental.php?od_id=" + od_id;
