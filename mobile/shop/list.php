                ...
                <div class="swiper-wrapper">
                    <? for ($bi = 0; $banner = sql_fetch_array($db_banners); $bi++) : ?>
                        <div class="swiper-slide">
                            ...
                            <? else : ?>
                                <img class="navigation-banner" src="/data/banner/category/<?= $banner['bn_file'] ?>" alt="<?= $banner['bn_alt'] ?>" style="width: 100%;">
                            <? endif ?>
    ...
    */
        ...
        */
            ...
            if ($i > 0 && $total_count > $items) {
                $qstr1 .= 'ca_id=' . $ca_id;
                if ($company_code) $qstr1 .= '$company_code=' . $company_code;
...
<script type="text/javascript">
    ...
    function updateNavigationWrapperSize() {
        const h = $("#navigation-banner-wrapper img").eq(0).height();
