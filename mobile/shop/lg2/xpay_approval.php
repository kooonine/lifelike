...
$LGD_RETURNURL			    = G5_MSHOP_URL.'/lg2/returnurl.php';
$LGD_KVPMISPNOTEURL         = G5_MSHOP_URL.'/lg2/note_url.php';
$LGD_KVPMISPWAPURL		    = G5_MSHOP_URL.'/lg2/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = G5_MSHOP_URL.'/lg2/cancel_url.php';
$LGD_MTRANSFERWAPURL        = G5_MSHOP_URL.'/lg2/returnurl.php';
$LGD_MTRANSFERCANCELURL     = G5_MSHOP_URL.'/lg2/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = G5_MSHOP_URL.'/lg2/note_url.php';
