...
<!-- <div id="display_pay_button" class="btn_confirm">
 ...
 -->
<div class="grid pay_btn">
    <div class="btn_group" id="show_req_btn" style="display:block;"><input type="button" name="submitChecked" onClick="pay_approval();" value="카드이체등록" class="btn big green"></div>
