...
<div id="sod_frm">
    ...
    <section id="sod_frm_orderer" >
        ...
        <div class="odf_tbl">
            ...
            <tr>
                <th scope="row"><label for="od_hp">휴대전화 번호</label></th>
    ...
    <section id="sod_frm_taker">
        ...
        <div class="odf_tbl">
            ...
            <tr>
                <th scope="row"><label for="od_b_hp">휴대전화 번호</label></th>
    ...
    <section id="sod_frm_pay">
        ...
        if ($default['de_hp_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_hp" name="od_settle_case" value="휴대전화" '.$checked.'> <label for="od_settle_hp">휴대전화</label></li>'.PHP_EOL;
            $checked = '';
        }
