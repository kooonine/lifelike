...
?>
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                <span class="prqty_price li_prqty_sp"><span>제품 금액 </span><?php echo number_format($row['ct_price']); ?></span>
...
<div id="sod_frm">
    ...
    <section id="sod_frm_orderer" >
        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    <label for="od_tel">연락처<strong class="sound_only"> 필수</strong></label>
    ...
    <section id="sod_frm_taker">
        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    <label for="od_b_tel">연락처<strong class="sound_only"> 필수</strong></label>
                    <input type="text" name="od_b_tel" id="od_b_tel" required class="frm_input required" maxlength="20">
                </li>
                <li>
                    <label for="od_b_hp">휴대전화 번호</label>
    ...
    <section id="sod_frm_pay">
        ...
        if ($default['de_hp_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_hp" name="od_settle_case" value="휴대전화" '.$checked.'> <label for="od_settle_hp" class="lb_icon hp_icon">휴대전화</label></li>'.PHP_EOL;
            $checked = '';
        }
