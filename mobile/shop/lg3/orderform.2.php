...
<div class="btn_group"  ><button type="button" onClick="pay_approval();" class="btn big green"><span>신청</span></button></div>
...
<div class="btn_group" id="show_req_btn" style="display:none;"><input type="button" name="submitChecked" onClick="pay_approval();" value="결제등록요청" class="btn big green"></div>
<div class="btn_group" id="show_pay_btn" style="display:none;"><input type="button" onClick="forderform_check();" value="주문하기" class="btn big green"></div>
 -->
