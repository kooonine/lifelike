...
$LGD_BUYERPHONE             = $_POST['LGD_BUYERPHONE'];         //구매자 휴대전화번호
$LGD_EASYPAY_ONLY           = $_POST['LGD_EASYPAY_ONLY'];       //페이나우결제창 호출

$LGD_RETURNURL			    = G5_MSHOP_URL.'/lg3/returnurl.php';
$LGD_KVPMISPNOTEURL         = G5_MSHOP_URL.'/lg3/note_url.php';
$LGD_KVPMISPWAPURL		    = G5_MSHOP_URL.'/lg3/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = G5_MSHOP_URL.'/lg3/cancel_url.php';
$LGD_MTRANSFERWAPURL        = G5_MSHOP_URL.'/lg3/returnurl.php';
$LGD_MTRANSFERCANCELURL     = G5_MSHOP_URL.'/lg3/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = G5_MSHOP_URL.'/lg3/note_url.php';
