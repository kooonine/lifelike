...
?>
    <ul class="sanchor">
        <li><a href="#sit_inf" <? if ($anc_id == 'inf') echo 'class="sanchor_on"'; ?>>상품정보</a></li>
        <li><a href="#sit_use" <? if ($anc_id == 'use') echo 'class="sanchor_on"'; ?>>사용후기 <span class="item_use_count"><?= $item_use_count; ?></span></a></li>
        <li><a href="#sit_qa" <? if ($anc_id == 'qa') echo 'class="sanchor_on"'; ?>>상품문의 <span class="item_qa_count"><?= $item_qa_count; ?></span></a></li>
        <? if ($default['de_baesong_content']) { ?><li><a href="#sit_dvr" <? if ($anc_id == 'dvr') echo 'class="sanchor_on"'; ?>>배송정보</a></li><? } ?>
        <? if ($default['de_change_content']) { ?><li><a href="#sit_ex" <? if ($anc_id == 'ex') echo 'class="sanchor_on"'; ?>>교환정보</a></li><? } ?>
    </ul>
<?
}
