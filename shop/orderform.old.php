...
if ($is_mobile_order) {
    if ($od_type == "R") {
        ...
        require_once(G5_MSHOP_PATH . '/orderform.sub.r.php');
    } else if ($od_type == "L" || $od_type == "K") {
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.l.php';
        require_once(G5_MSHOP_PATH . '/orderform.sub.l.php');
    } else if ($od_type == "S") {
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.s.php';
        require_once(G5_MSHOP_PATH . '/orderform.sub.s.php');
    } else {
    ...
    if ($od_type == "R") {
        // $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.r.old.php';
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.r.php';
        require_once(G5_SHOP_PATH . '/orderform.sub.r.php');
    } else if ($od_type == "L" || $od_type == "K") {
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.l.php';
        require_once(G5_SHOP_PATH . '/orderform.sub.l.php');
    } else if ($od_type == "S") {
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.s.php';
        require_once(G5_SHOP_PATH . '/orderform.sub.s.php');
    } else {
        $order_action_url = G5_HTTPS_SHOP_URL . '/orderformupdate.php';
