						...
						?>
							...
							?>
								<div class="cont right_cont">
									<span class="chk check">
										...
										<? } ?>
										<input type="hidden" name="ct_id[<?= $i ?>]" value="<?= $row['ct_id'] ?>" id="ct_id_<?= $i ?>">
										<input type="hidden" name="it_name[<?= $i ?>]" value="<?= $row['it_name'] ?>" id="it_name_<?= $i ?>">
									</span>
									<div class="photo"><?= $image; ?></div>
									<div class="info">
										<strong><a href="./item.php?it_id=<?= $row['it_id'] ?>"><?= $row['it_name']; ?></a></strong>
										<p><span class="txt">옵션</span><span class="point_black"><?= get_text($row['ct_option']); ?></span></p>
										<p><span class="txt">주문일</span><span class="point_black"><?= substr($od['od_time'], 0, 10); ?></span></p>
										...
										<? if ($ct_send_cost) { ?><p><span class="txt">배송비</span><span class="point_black"><?= number_format($ct_send_cost); ?> 원</span></p><? } ?>
									</div>
									<div class="pay_item">
										결제 금액<span class="amount"><strong><?= number_format($sell_price); ?> 원</strong></span>
										<input type="hidden" name="stotal[<?= $i ?>]" value="<?= $sell_price ?>" id="stotal_<?= $i ?>">
										<input type="hidden" name="ct_send_cost[<?= $i ?>]" value="<?= $ct_send_cost ?>" id="ct_send_cost_<?= $i ?>">
									</div>
									<div class="clear"></div>
								</div>
							<?
								...
								<div class="cont right_cont">
									...
									<div class="info">
										...
										<p><span class="txt">신청일</span><span class="point_black"><?= substr($od['od_time'], 0, 10); ?></span></p>
									</div>
									<div class="pay_item">
										리스 금액<span class="amount"><strong><?= number_format($sell_rental_price); ?> 원</strong></span>
										<input type="hidden" name="stotal[<?= $i ?>]" value="<?= $sell_rental_price ?>" id="stotal_<?= $i ?>">
										<input type="hidden" name="ct_send_cost[<?= $i ?>]" value="<?= $ct_send_cost ?>" id="ct_send_cost_<?= $i ?>">
									</div>
									<div class="clear"></div>
								</div>
							<? } else if ($od['od_type'] == "L") { ?>
								<div class="cont right_cont">
									...
									<div class="pay_item">
										...
										<input type="hidden" name="stotal[<?= $i ?>]" value="<?= $row['ct_receipt_price'] ?>" id="stotal_<?= $i ?>">
										<input type="hidden" name="ct_send_cost[<?= $i ?>]" value="<?= $ct_send_cost ?>" id="ct_send_cost_<?= $i ?>">
									</div>
									<div class="clear"></div>
								</div>
							...
							<? } else if ($od['od_type'] == "S") { ?>
								<div class="cont right_cont">
									...
									<div class="pay_item">
										결제 금액<span class="amount"><strong><?= ($row['ct_receipt_price']) ? display_price($row['ct_receipt_price']) . " 원" : "후불"; ?></strong></span>
										<input type="hidden" name="stotal[<?= $i ?>]" value="<?= $row['ct_receipt_price'] ?>" id="stotal_<?= $i ?>">
										<input type="hidden" name="ct_send_cost[<?= $i ?>]" value="<?= $ct_send_cost ?>" id="ct_send_cost_<?= $i ?>">
									</div>
									<div class="clear"></div>
