...
<input type="hidden" name="pp_id" value="<?php echo $pp['pp_id']; ?>">
    ...
    <section id="sod_frm_pay" class="pesonal sod_left ">
        ...
        <div class="tbl_frm01 tbl_wrap ">
            ...
            <tr>
                <th scope="row"><label for="pp_hp">휴대전화</label></th>
    ...
    <div class="sod_right" id="personal_pay">
        ...
        if ($default['de_hp_use']) {
            $multi_settle++;
            echo '<input type="radio" id="pp_settle_hp" name="pp_settle_case" value="휴대전화" '.$checked.'> <label for="pp_settle_hp"  class="lb_icon hp_icon">휴대전화</label>'.PHP_EOL;
            $checked = '';
        }
