...
if ($od_memo == "user") $od_memo = clean_xss_tags($od_memo_user);
$od_b_hp			= hyphen_hp_number($od_b_hp_1 . $od_b_hp_2);
...
fbq("track", "PageView");
	...
	fbq("track", "Purchase", {value: "' . $tot_ct_price + $od_send_cost . '", currency: "KRW"});
...
function mobConv() {
    var cn = new EN();
    cn.setData("uid", "litandard");
    cn.setData("ordcode", "");
    cn.setData("qty", "' . $scriptQty . '");
    cn.setData("price", "' . $tot_ct_price + $od_send_cost . '");
