...
$sql_search .= " and (mb_today_login <= '".$fr_mb_today_login."' and mb_datetime <= '".$fr_mb_today_login."') ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" id="mb_list_join"><?php echo subject_sort_link('mb_datetime', '', 'desc') ?>휴면처리일</a></th>
        ...
        <th scope="col" id="mb_list_mng">회원가입일</th>
        <th scope="col" id="mb_list_mng">최종접속일</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_join" class="td_date"><?php echo substr($row['mb_datetime'],2,8); ?></td>
        <td headers="mb_list_join" class="td_date"><?php echo substr($row['mb_today_login'],2,8); ?></td>
    </tr>
