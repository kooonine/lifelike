...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_title">
				<h4><span class="fa fa-check-square"></span> 게시판 목록<small></small></h4>
							...
							<thead>
								<tr>
									<th colspan="<?php echo $colspan ?>" style="text-align: right;">
										...
										<a href="board_create.php"><button class="btn btn_03" type="button">게시판 생성</button></a>
									</th>
								</tr>
								<tr>
									<th scope="col">
	...
	<div class="x_content">
		...
		<div id="bo_btn_top">
			...
			<div style="position:absolute; right: 0; top:0;">
				<input type="button" name="del_button" value="삭제" onclick="new_notice_del()" class="btn btn-danger">
			</div>
			<?endif?>
		</div>
		<!-- } 게시판 페이지 정보 및 버튼 끝 -->
...
function new_notice_del(){
	...
	$("input[name='chk_wr_id[]']:checked").each(function() {		
		...
		var wr_id = this.value;         
		$.ajax({
			url:'./board_delete.new_notice.php',
			type:'get',
			async: false,
			data:{wr_id : wr_id },
