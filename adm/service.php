...
<div class="service_wrap">
    ...
    <div class="sevice_1 svc_phone">
        <h3>휴대전화 본인확인 서비스</h3>
        <p>정보통신망법 23조 2항(주민등록번호의 사용제한)에 따라 기존 주민등록번호 기반의 인증서비스 이용이 불가합니다. 주민등록번호 대체수단으로 최소한의 정보(생년월일, 휴대전화번호, 성별)를 입력받아 본인임을 확인하는 인증수단 입니다</p>

        <ul>
            <li><a href="http://sir.kr/main/service/p_cert.php" target="_blank"><img src="<?php echo G5_ADMIN_URL ?>/img/svc_btn_01.jpg" alt="KCP 휴대전화 본인확인 신청하기"></a></li>
            <li><a href="http://sir.kr/main/service/lg_cert.php" target="_blank"><img src="<?php echo G5_ADMIN_URL ?>/img/svc_btn_02.jpg" alt="유플러스 휴대전화 본인확인 신청하기"></a></li>
            <li class="last"><a href="http://sir.kr/main/service/b_cert.php" target="_blank"><img src="<?php echo G5_ADMIN_URL ?>/img/svc_btn_03.jpg" alt="오케이네임 휴대전화대체인증 신청하기"></a></li>
    ...
    <div class="service_2">
        <div class="svc_ri svc_sms">
                <div class="svc_a">
                    <h3>SMS 문자 서비스</h3>
                    <p>주문이나 배송시에 상점운영자 또는 고객에게 휴대전화으로 단문메세지 (최대 한글 40자, 영문 80자)를 발송합니다.</p>
                </div>
