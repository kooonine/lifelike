...
if(isset($act) && $act == "exceldownload"){
    ...
    $headers = array('NO','주문연도','주문수 총 합계','(총)주문금액','(총)배송비','쿠폰 할인','적립금사용','결제 총 합계','할인합계','주문취소','환불금액','미수금');
    $bodys = array('NO','od_date','ordercount','orderprice','send_cost','ordercoupon','receiptpoint','receipt_price','discountprice','ordercancel','refund_price','misu');
