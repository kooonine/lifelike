...
if ($w == "u") {
    $html_title .= " 수정";
    $sql = " select * from lt_temper where tp_id = '$tp_id' ";
    $tp = sql_fetch($sql);
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <form name="frmnewwin" action="./temper.update.php" onsubmit="return submit_check(this);" method="post" enctype="multipart/form-data">
                        ...
                        <table>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-6">
                                            <div class="input-group">
                                                ...
                                                <!-- <button class="btn btn-danger <?php if (!$tp['tp_img']) echo 'hidden'; ?>" type="button" id="btnDelimgFile" fileBtnID="imgFile">삭제</button> -->
                                                <!-- <input type="hidden" id="orgimgFile" name="org_ba_image" value="<?php echo $tp['tp_img']; ?>"> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="radio">
                                            <label><input type="radio" name="tp_use" value=0 <?php echo get_checked($tp['tp_use'], 0) ?>>미사용</label>&nbsp;&nbsp;
                                            <label><input type="radio" name="tp_use" value=1 <?php echo get_checked($tp['tp_use'], 1) ?>>사용</label>&nbsp;&nbsp;
                                        </div>
                                    </td>
                                    </td>
                                </tr>
                ...
                <div class="x_content">
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                            <a href="./temper.list.php" class=" btn btn_02">목록</a>
