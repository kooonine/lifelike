...
if ($w == '') {
    ...
    $title_msg = '수정';
    $sql = " select * from lt_event where cp_id = '$cp_id' ";
    $cp = sql_fetch($sql);
...
$g5['title'] = "이벤트 " . $title_msg;
include_once('../admin.head.php');

$action_url = https_url('adm') . "/re/event.update.php";
$categories = array(
    'THEME' => '테마전',
    'MD' => 'MD`s Pick',
    'BRAND' => 'BRAND',
                                    ...
                                    <td colspan="2">
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row"><label for="cp_review">리뷰이벤트</label></th>
                                                    <td>
                                                        <input type="checkbox" name="cp_review_chk" value="1" id="cp_review_chk" <?php echo get_checked($cp['cp_review'], 1) ?> onclick="">
                                                        <label for="cp_review_chk">사용</label>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="x_content">
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <a href="/adm/re/event.list.php"><button class="btn btn_02" type="button">목록</button></a>
