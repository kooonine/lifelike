...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_title">
                <h4><span class="fa fa-check-square"></span> 기획전/이벤트 목록<small></small></h4>
            ...
            <div class="x_content">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 text-right pull-right">
                        <a href="./campaign.update.form.php" class="btn btn-success">신규등록</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?php echo $bg; ?>">
                                    ...
                                    <td class="td_left">
                                        <a href="./campaign.update.form.php?w=u&amp;cp_id=<?php echo $row['cp_id']; ?>"><?php echo $row['cp_subject']; ?></a>
                                    </td>
                                    ...
                                    <td class="td_mng td_mng_m">
                                        <a href="./campaign.update.form.php?w=u&amp;cp_id=<?php echo $row['cp_id']; ?>" class="btn btn-success"><span class="sound_only"><?php echo $row['cp_subject']; ?> </span>수정</a>
                                        <a href="./campaign.update.php?w=d&amp;cp_id=<?php echo $row['cp_id']; ?>" onclick="return delete_confirm(this);" class="btn btn-danger"><span class="sound_only"><?php echo $row['cp_subject']; ?> </span>삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
