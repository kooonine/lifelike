...
<div class="modal-content">
  ...
  <div class="modal-body">
    ...
    <form name="fboardlist2" id="fboardlist2" action="./post_management_list_update.php" onsubmit="return fboardlist_submit2(this);" method="post">
        ...
        <tbody>
        <?php 
        $sql = " select a.*, b.bo_subject from lt_write_delete as a, {$g5['board_table']} as b where a.bo_table = b.bo_table and wr_is_comment = '0' order by a.wr_del_datetime desc ";
        if($test) echo $sql.'<br/>';
