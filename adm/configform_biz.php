...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<input type="hidden" name="token" value="" id="token">
	  ...
	  <?php 
	  $de_admin_accounting_names = explode("||",$default['de_admin_accounting_name']);
	  $de_admin_accounting_tels = explode("||",$default['de_admin_accounting_tel']);
	  $de_admin_accounting_emails = explode("||",$default['de_admin_accounting_email']);
	  
	  ?>
	  <ui style="list-style:none;">
    	  <?php
    	  for ($i = 0; $i < count($de_admin_accounting_names); $i++) {
    	  ?>
    	  <li class="x_content" <?php echo ($i==0)?'id="dvAccounting"':''; ?>>
    		  <div class="form-group">
    			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="de_admin_company_saupja_no">회계(정산) 담당자</span>
    			</label>
    			<div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="de_admin_accounting_name[]" value="<?php echo $de_admin_accounting_names[$i]; ?>" id="de_admin_accounting_name" class="form-control col-md-7 col-xs-12" size="30">
    			</div>
    			<?php if($i!=0){?>
    			<div style="float: right;">
    			  <input type="button" class="btn del_item" value="삭제">
    			</div>
    			<?php } ?>
    		  </div>
    		  <div class="form-group">
    			...
    			<div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="de_admin_accounting_tel[]" value="<?php echo $de_admin_accounting_tels[$i]; ?>" id="de_admin_accounting_tel" class="form-control col-md-7 col-xs-12" size="30">
    			</div>
    		  </div>
    		  <div class="form-group">
    			...
    			<div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="de_admin_accounting_email[]" value="<?php echo $de_admin_accounting_emails[$i]; ?>" id="de_admin_accounting_email" class="form-control col-md-7 col-xs-12" size="30">
    			</div>
    		  </div>
    		  <div class="ln_solid"></div>
    	  </li>
...
<script type="text/html" id="accounting-template">
<li class="x_content">
	  <div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="de_admin_company_saupja_no">회계(정산) 담당자</span>
		</label>
		<div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="de_admin_accounting_name[]" value="" id="de_admin_accounting_name" class="form-control col-md-7 col-xs-12" size="30">
		</div>
			<div style="float: right;">
			  <input type="button" class="btn del_item" value="삭제">
			</div>
	  ...
	  <div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="de_admin_accounting_tel[]" value="" id="de_admin_accounting_tel" class="form-control col-md-7 col-xs-12" size="30">
		</div>
	  </div>
	  <div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="de_admin_company_saupja_no">담당자 이메일</span>
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="de_admin_accounting_email[]" value="" id="de_admin_accounting_email" class="form-control col-md-7 col-xs-12" size="30">
		</div>
	  </div>
	  <div class="ln_solid"></div>
</li>
...
$(function(){
	...
	$("#accounting_add").click(function(){
		
		$targetSel = $("#dvAccounting");
		var i = $("input[name='de_admin_accounting_name[]']").length;
		
		var template = $('#accounting-template').text();
        template = $(template);
		template.prop('id', 'accounting' + i);
		  
        $targetSel.after(template);
