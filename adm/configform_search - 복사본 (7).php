...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<input type="hidden" name="token" value="" id="token">
	  ...
	  <div class="x_title">
		<h2><span class="fa fa-check-square"></span> 기본정보 설정<small></small></h2>
	  ...
	  <div class="x_content">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-2 col-sm-2 col-xs-12">
				<div class="radio">
					<label><input type="radio" class="flat" name="de_admin_tongsin_no_use" id="de_admin_tongsin_no_use1" value="1" <? if($config['de_admin_tongsin_no_use'] == "1") { ?>checked="" <? } ?> required /> 신고함</label>
                    <label><input type="radio" class="flat" name="de_admin_tongsin_no_use" id="de_admin_tongsin_no_use0" value="0" <? if($config['de_admin_tongsin_no_use'] == "0") { ?>checked="" <? } ?> /> 신고안함</label>
				</div>
			</div>
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="de_admin_company_saupja_no">/ 통신판매업 번호</span>
			</label>
			<div class="col-md-2 col-sm-2 col-xs-12">
                <input type="text" name="de_admin_tongsin_no" value="<?php echo $default['de_admin_tongsin_no']; ?>" id="de_admin_tongsin_no" class="form-control col-md-7 col-xs-12" size="30">
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-md-2 col-sm-2 col-xs-12">
				<div class="radio">
					<label><input type="radio" class="flat" name="de_admin_buga_no_use" id="de_admin_buga_no_use1" value="1" <? if($config['de_admin_buga_no_use'] == "1") { ?>checked="" <? } ?> required /> 신고함</label>
                    <label><input type="radio" class="flat" name="de_admin_buga_no_use" id="de_admin_buga_no_use0" value="0" <? if($config['de_admin_buga_no_use'] == "0") { ?>checked="" <? } ?> /> 신고안함</label>
				</div>
			</div>
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="de_admin_company_saupja_no">/ 부가통신사업자 번호</span>
			</label>
			<div class="col-md-2 col-sm-2 col-xs-12">
                <input type="text" name="de_admin_buga_no" value="<?php echo $default['de_admin_buga_no']; ?>" id="de_admin_buga_no" class="form-control col-md-7 col-xs-12" size="30">
			</div>
		  </div>
	  ...
	  <div class="x_title">
		<h2><span class="fa fa-check-square"></span> 고객센터정보 안내설정 <small></small></h2>
		<label class="nav navbar-right"></label>
		<div class="clearfix"></div>
	  </div>
	  ...
	  <div class="x_title">
		<h2><span class="fa fa-check-square"></span> 개인정보 관리책임자 안내 설정 <small></small></h2>
		<label class="nav navbar-right"></label>
		<div class="clearfix"></div>
	  </div>
	  ...
	  <div class="x_title">
		<h2><span class="fa fa-check-square"></span> 업무별 책임자 설정 <small></small></h2>
		<label class="nav navbar-right"></label>
		<div class="clearfix"></div>
	  </div>
