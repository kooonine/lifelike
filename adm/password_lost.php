...
$action_url = "./password_lost2.php";
?>

<!-- 회원정보 찾기 시작 { -->
<div id="find_info" class="new_win">
<h1 id="win_title">비밀번호 찾기 팝업</h1>
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <tr>
        <th scope="col" class="text-center active" style="vertical-align: middle;" width="20%">아이디</th>
        <td scope="col" class="text-center" style="vertical-align: middle;">
        	<input type="text" name="mb_id" id="mb_id" required class="required frm_input full_input" size="30" placeholder="아이디">
