...
$mo_code = array('15001','19940','19942','19943','19944','19945','19950','19951','19952','19953','19954','19955','19956','19957','19958','19961','19962','19963','19964','19965','19966','19967','19968','19970','19971','19972','19973','19974','19975','19976','19977','19979');
...
if($sfl){
    if($stx){
        switch($sfl){
            case 'samjin_name':
                $sql_search .= " and samjin_name like '%{$stx}%' ";
                break;
            case 'samjin_code':
        ...
        if($sfl == 'mall_code'){
            if (in_array($stx, $mo_code)) {
                $sql_search .= " and m{$stx} is not null ";
            }else{
                $sql_search .= " and sno = 0";
            }
        }
    }else{
...
FROM  samjin_order_delivery_order {$sql_search}
GROUP BY dpartner_name, samjin_name,samjin_color, samjin_size, warehouse_no";
...
$sql = "SELECT samjin_name, samjin_code, samjin_brand, samjin_color, samjin_size, warehouse_no 
, SUM(m15001) AS m15001, SUM(m19940) AS m19940, SUM(m19942) AS m19942, SUM(m19943) AS m19943, SUM(m19944) AS m19944, SUM(m19945) AS m19945
, SUM(m19950) AS m19950, SUM(m19951) AS m19951, SUM(m19952) AS m19952, SUM(m19953) AS m19953, SUM(m19954) AS m19954
, SUM(m19955) AS m19955, SUM(m19956) AS m19956
, SUM(m19957) AS m19957, SUM(m19958) AS m19958, SUM(m19961) AS m19961, SUM(m19962) AS m19962
, SUM(m19963) AS m19963, SUM(m19964) AS m19964, SUM(m19965) AS m19965, SUM(m19966) AS m19966
, SUM(m19967) AS m19967, SUM(m19968) AS m19968, SUM(m19970) AS m19970, SUM(m19971) AS m19971
, SUM(m19972) AS m19972, SUM(m19973) AS m19973, SUM(m19974) AS m19974, SUM(m19975) AS m19975
, SUM(m19976) AS m19976, SUM(m19977) AS m19977, SUM(m19978) AS m19978, SUM(m19979) AS m19979
FROM samjin_order_delivery_order {$sql_search}
GROUP BY dpartner_name, samjin_name,samjin_color, samjin_size, warehouse_no limit $from_record, $rows";
...
$oform_headers = array('삼진품목명','삼진코드','브랜드명','색상','사이즈','15001','19940','19942','19943','19944','19945','19950','19951','19952','19953','19954','19955','19956','19957','19958','19961','19962','19963','19964','19965','19966','19967','19968','19970','19971','19972','19973','19974','19975','19976','19977','19978','19979','창고번호');
$oform_bodys = array('samjin_name','samjin_code','samjin_brand','samjin_color','samjin_size','m15001','m19940','m19942','m19943','m19944','m19945','m19950','m19951','m19952','m19953','m19954','m19955','m19956','m19957','m19958','m19961','m19962','m19963','m19964','m19965','m19966','m19967','m19968','m19970','m19971','m19972','m19973','m19974','m19975','m19976','m19977','m19978','m19979','warehouse_no');
        ...
        <tbody id="revenue-status">
            ...
            <tr>
                <td>
                    ...
                    <input type="hidden" name="sno[<?=$ofi?>]" value="<?=$row_ord['samjin_name']?>" id="sno_<?=$ofi?>">
                </td>
                <td><?=$row_ord['warehouse_no']?></td>
                <td><?=$row_ord['samjin_name']?></td>
                <td><?=$row_ord['samjin_code']?></td>
                <td><?=$row_ord['samjin_brand']?></td>
...
<?php echo get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, "{$_SERVER['SCRIPT_NAME']}?$qstr&amp;page="); ?>
    ...
    <script>
        ...
        function down_excel(){
            ...
            //excel_sql = "SELECT samjin_name, samjin_code, samjin_brand, samjin_color, samjin_size , SUM(m15001) AS m15001, SUM(m19953) AS m19953, SUM(m19954) AS m19954, SUM(m19956) AS m19956, SUM(m19957) AS m19957, SUM(m19958) AS m19958, SUM(m19961) AS m19961, SUM(m19962) AS m19962, SUM(m19963) AS m19963, SUM(m19964) AS m19964, SUM(m19965) AS m19965, SUM(m19966) AS m19966, SUM(m19967) AS m19967, SUM(m19968) AS m19968, SUM(m19970) AS m19970, SUM(m19971) AS m19971, SUM(m19972) AS m19972, SUM(m19973) AS m19973, SUM(m19974) AS m19974, SUM(m19975) AS m19975, SUM(m19976) AS m19976, SUM(m19977) AS m19977, SUM(m19979) AS m19979 FROM samjin_order_delivery_order <?=$sql_search?> and samjin_name in ( "+selects+" ) GROUP BY dpartner_name, samjin_name,samjin_color, samjin_size";
            ...
            var $form = $('<form></form>');     
            $form.attr('action', '<?=G5_ADMIN_URL?>/ajax.excel_download.total_order_delivery_order.php');
            ...
            $form.append(sec).append(exceldata).append(headerdata).append(bodydata).append(excelnamedata);
            $form.submit();
