...
if ($od_status_claim) {
    $where[] = " a.od_status_claim = '$od_status_claim' ";
}
...
$headers = array('NO', '주문일시','주문번호', '주문상태','세탁구분','주문자아이디','주문자명', '상품코드', '상품명', '옵션항목', 'ORDERNO', 'RFID');
$bodys = array('NO', 'od_time','disp_od_id', 'od_status','ct_free_laundry','mb_id','od_name', 'it_id', 'it_name', 'ct_option', 'its_order_no', 'rf_serial');
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td rowspan="<?php echo $rowspan ?>">
        	...
        	<?php echo substr($row['od_time'],0,10) ?><br/>
        ...
        <td class="td_num"><?php echo ($opt['ct_free_laundry_use'])?"무료":"유료"; ?></td>
    </tr>    
    <?php
    }
