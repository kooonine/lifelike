...
$LGD_CASHCARDNUM            = $_POST['id_info'];                        //발급번호(주민등록번호,현금영수증카드번호,휴대전화번호 등등)
	...
	<div class="inner_layer">
		<div class="content comm sub">
    		<div class="grid" style="width:90%">
    			<div class="title_bar">
    				<h1 class="g_title_01">현금영수증 - LG유플러스 eCredit</h1>
    			</div>
				...
				<div class="order_list gray_box">
					<ul>
                        ...
                        <li>
                            <span class="item">결과코드</span>
                            <strong class="result"><?php echo $xpay->Response_Code(); ?></strong>
                        </li>
                        <li>
                            <span class="item">결과 메세지</span>
                            <strong class="result"><?php echo $xpay->Response_Msg(); ?></strong>
                        </li>
                        <li>
                            <span class="item">현금영수증 거래번호</span>
                            <strong class="result"><?php echo $xpay->Response("LGD_TID",0); ?></strong>
                        </li>
                        <li>
                            <span class="item">현금영수증 승인번호</span>
                            <strong class="result"><?php echo $xpay->Response("LGD_CASHRECEIPTNUM",0); ?></strong>
                        </li>
                        <li>
                            <span class="item">승인시간</span>
                            <strong class="result"><?php echo preg_replace("/([0-9]{4})([0-9]{2})([0-9]{2})([0-9]{2})([0-9]{2})([0-9]{2})/", "\\1-\\2-\\3 \\4:\\5:\\6",$xpay->Response("LGD_RESPDATE",0)); ?></strong>
                        </li>
					</ul>

            		<div class="btn_group"  id="show_pay_btn">
            			<button type="button" name="receiptView" class="btn big green" onClick="javascript:showCashReceipts('<?php echo $LGD_MID; ?>','<?php echo $LGD_OID; ?>','<?php echo $od_casseqno; ?>','<?php echo $trade_type; ?>','<?php echo $CST_PLATFORM; ?>');">영수증 확인</button>
					</div>
                    <span>
                        <b>영수증 확인은 실 등록의 경우에만 가능합니다.</b>
                    </span>
