...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="de_hp_use">휴대전화결제사용</label></th>
            <td>
                <?php echo help("주문시 휴대전화 결제를 가능하게 할것인지를 설정합니다.", 50); ?>
        ...
        <tr>
            ...
            <td>
                <?php echo help("신용카드, 계좌이체, 휴대전화 결제시 포인트를 부여할지를 설정합니다. (기본값은 '아니오')"); ?>
            ...
            <td>
                ...
                <div id="scf_cardtest_tip">
                    ...
                    <dl>
                        ...
                        <dt>휴대전화</dt><dd>1004원, 실결제가 되며 다음날 새벽에 일괄 취소됨</dd>
                    </dl>
...
<section id="anc_scf_sms" >
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="de_sms_hp">관리자 휴대전화번호</label></th>
            <td>
