            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    switch ($row['cp_method']) {
                        ...
                        case '4':
                            $cp_method = '브랜드 할인';
                            $cp_target = get_text($row['cp_target']);
                            break;
                        case '31':
                            $cp_method = '포인트 쿠폰';
                            // $cp_target = '';
                            $cp_price = $row['cp_point_coupon_amount'].'P';
                            break;
                        case '21':
                            $cp_method = '등급쿠폰할인';
                            $cp_target = '등급금액';
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_mng td_mng_s">
                            <a href="./download_coupon_issuance_history.php?cz_id=<?php echo $row['cz_id']; ?>" class="btn btn_03">조회</a>
                        </td>
                    </tr>
