            ...
            <div class="tbl_frm01">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><span class="sound_only">주문하신 분 </span>연락처</th>
            ...
            <div class="tbl_frm01">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><span class="sound_only">받으시는 분 </span>연락처</th>
                        ...
                        <tr>
                            ...
                            <td><?php if ($data['od_memo']) echo get_text($data['od_memo'], 1);
                                else echo "없음"; ?></td>
                        </tr>
                    </tbody>
                </table>
