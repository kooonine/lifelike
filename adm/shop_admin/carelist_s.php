...
$headers = array('NO', '주문일시','주문번호', '주문자아이디','주문자명', '상품코드', 'ORDERNO', 'RFID', '상품명', '옵션항목');
$bodys = array('NO', 'od_time','disp_od_id','mb_id','od_name', 'it_id', 'its_order_no', 'rf_serial', 'it_name', 'ct_option');
