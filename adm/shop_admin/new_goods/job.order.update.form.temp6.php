    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="6">
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    ?>
                                        <tr class="btn-add-mater mater_1" data-item-idx=1 >
                                            ...
                                            <td colspan = "2">
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_mater_info_danga[1]" id="jo_mater_info_danga_1" data-mater-idx="1" onblur="mater_math1(this)" value="">
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            ...
                                            <input type="hidden" class="noborder_th txt_right func_th print_hidden" id ="total_mater_price" onblur="comma_input(this)" name ="total_mater_price" value ="<?=number_format($total_mater_price)?>" > 
                                        </th>
                                    </tr>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        ?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[1]" value="메인라벨(소프라운 직조)"></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_size[1]" value=""></td>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="55">
                                                </td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_2" data-item-idx=2>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[2]" id="jo_sub_mater_info_danga_2" data-sub-mater="2" onblur="sub_mater_math(this)" value="50">
                                                </td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_3" data-item-idx=3>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[3]" id="jo_sub_mater_info_danga_3" data-sub-mater="3" onblur="sub_mater_math(this)" value="40">
                                                </td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_4" data-item-idx=4>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[4]" id="jo_sub_mater_info_danga_4" data-sub-mater="4" onblur="sub_mater_math(this)" value="40">
                                                </td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_5" data-item-idx=5>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[5]" value="차렵이불 가방"></td>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[5]" id="jo_sub_mater_info_danga_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="1,400">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[5]" id="jo_sub_mater_info_price_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="1,400"></td>
                                            </tr>
                                        ...
                                        ?>
                                            ...
                                            <?for($smaidx = $cnt_sub_mater; $smaidx < 9 ; $smaidx++) : ?>
                                                <tr class="btn-add-sub-mater sub-mater_<?=$smaidx?>" data-item-idx=<?=$smaidx?> >
                                                    <td class="noline_left noline_top">
                                                        <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_sub_mater_info[<?=$smaidx?>]">
                                                        <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_sub_mater_info_no[<?=$smaidx?>]" value = "<?=$smaidx?>">
                                                    </td>
                                                    <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[<?=$smaidx?>]" value=""></td>
                                                    <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_size[<?=$smaidx?>]" value=""></td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_hei[<?=$smaidx?>]" value=""></td>
                                                    <td></td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_length[<?=$smaidx?>]" value=""></td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[<?=$smaidx?>]" id="jo_sub_mater_info_yd_<?=$smaidx?>" data-sub-mater="<?=$smaidx?>" onblur="sub_mater_math(this)" value="1.0"></td>
                                                    <td colspan = "2">
                                                    
                                                        <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[<?=$smaidx?>]" id="jo_sub_mater_info_danga_<?=$smaidx?>" data-sub-mater="<?=$smaidx?>" onblur="sub_mater_math(this)" value="">
                                                    </td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[<?=$smaidx?>]" id="jo_sub_mater_info_price_<?=$smaidx?>" data-sub-mater="<?=$smaidx?>" onblur="sub_mater_math(this)" value=""></td>
                                                </tr>
                                            <?endfor?>
                                        <?endif?>
                                    ...
                                    <tr class="btn-add-mater-price mater_price_1" data-item-idx=1 >
                                        ...
                                        <th colspan = "12"  class="txt_left" >제품 매입 단가 (부가세 별도)</th>
                                        
                                        </th>
                                        <th><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[1]" id="jo_maip_price_price_1" data-price-idx="1" onblur="maip_price_temp6(this)" value="<?=$jo_maip_price[1]['price'] ? number_format($jo_maip_price[1]['price']) : ''?>"></th>
                                    </tr>
                                </table>
                        ...
                        <tr class="memo_info_aera">
                            ...
                            <td id="noline_td" colspan = "17">
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <th colspan = "12" class="txt_left"> 생산원가(원자재계+부자재계+제품매입단가) </th>
                                        <th class="txt_right">
...
<script>
    ...
    function add_mater(){
        ...
        setHtml +='<td colspan = "4" style="text-align : left;"><select class="mater_select" name="jo_mater_info_main[' + nextIdx + ']"><option value = "">선택</option><option value = "메인">메인</option><option value = "코디">코디</option><option class="etc_soje" value = "코디1">코디1</option><option value = "안감">안감</option></select>';
    ...
    function add_sub_mater(){
        ...
        setHtml += '<td><input onfocus="Vail_fixed(this)" class="noborder" id="jo_sub_mater_info_yd_' + nextIdx + '" name="jo_sub_mater_info_yd[' + nextIdx + ']"  onblur="sub_mater_math(this)" value="1.0"></td>';
    ...
    function prod_origin_price(){
        ...
        //제품매입단가
        let c = $('#jo_maip_price_price_1').val().replace(/,/gi,'');
    ...
    function maip_price_temp6(elem){
        comma_input(elem);
        prod_origin_price();
    }
    ...
    function unim_math(elem){
        ...
        let lavel = $('#jo_mater_info_price_2').val().replace(/,/gi,'');
    ...
    function unim_math1(elem){
        ...
        let bongje = $('#jo_maip_price_price_1').val().replace(/,/gi,'');
        
        let price = ((bongje*1) +(total_mater_price*1)) *  yo / 100 ;
        price = Math.floor(price);
        $('#jo_maip_price_price_'+id).val(comma(price+""));
        ...
        //     total_mater_price += (fileData[i]*1);
        // }
        var fileValue_price = $(".jo_maip_price_price").length;
        var fileData_price = new Array(fileValue_price);
        let total_mater_price_price = 0;
        let total_mater_price_fin = 0;
        let total_mater_price_fin1 = 0;
        for(var i=0; i<fileValue_price; i++){                          
            fileData_price[i] = $(".jo_maip_price_price")[i].value.replace(/,/gi,'');
            total_mater_price_price += (fileData_price[i]*1);
        }
        
        let etc = $('#jo_maip_price_price_4').val().replace(/,/gi,'');

        total_mater_price_fin = parseInt((total_mater_price_price + total_mater_price - (etc*1)) * 100) / 100;
        total_mater_price_fin1 = parseInt((total_mater_price_price + total_mater_price) * 100) / 100;
        $('#total_mater_price').val(comma(total_mater_price_fin+""));
        $('#total_mater_price_view').empty().html(comma(total_mater_price_fin+""));
        $('#total_mater_price_fin').val(comma(total_mater_price_fin1+""));
        $('#total_mater_price_view_fin').empty().html(comma(total_mater_price_fin1+""));
        prod_origin_price();
    }
    ...
    function kanse_math1(elem){
        ...
        let origin = $('#jo_maip_price_price_1').val().replace(/,/gi,'');
        let unim = $('#jo_maip_price_price_2').val().replace(/,/gi,'');
        

        let price = ((origin*1) +(total_mater_price*1) +(unim*1)) *  yo / 100 ;
