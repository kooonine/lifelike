    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="4">
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    ?>
                                        <tr class="btn-add-mater mater_1" data-item-idx=1 >
                                            ...
                                            <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_mater_info_title[1]" value=""></td>
                                        ...
                                        <tr class="btn-add-mater mater_2" data-item-idx=2 >
                                            ...
                                            <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_mater_info_title[2]" value=""></td>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        ?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[1]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[1]" id="jo_sub_mater_info_yd_1" data-sub-mater="1" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[1]" id="jo_sub_mater_info_price_1" data-sub-mater="1" onblur="sub_mater_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_2" data-item-idx=2>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[2]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[2]" id="jo_sub_mater_info_yd_2" data-sub-mater="2" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[2]" id="jo_sub_mater_info_danga_2" data-sub-mater="2" onblur="sub_mater_math(this)" value="">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[2]" id="jo_sub_mater_info_price_2" data-sub-mater="2" onblur="sub_mater_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_3" data-item-idx=3>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[3]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[3]" id="jo_sub_mater_info_yd_3" data-sub-mater="3" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2">
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[3]" id="jo_sub_mater_info_price_3" data-sub-mater="3" onblur="sub_mater_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_4" data-item-idx=4>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[4]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[4]" id="jo_sub_mater_info_yd_4" data-sub-mater="4" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_sub_mater_info_danga[4]" id="jo_sub_mater_info_danga_4" data-sub-mater="4" onblur="sub_mater_math(this)" value="">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[4]" id="jo_sub_mater_info_price_4" data-sub-mater="4" onblur="sub_mater_math(this)" value=""></td>
                                            </tr>
                                        ...
                                        ?>
                                            ...
                                            <?for($smaidx = $cnt_sub_mater; $smaidx < 9 ; $smaidx++) : ?>
                                                <tr class="btn-add-sub-mater sub-mater_<?=$smaidx?>" data-item-idx=<?=$smaidx?> >
                                                    ...
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[<?=$smaidx?>]" id="jo_sub_mater_info_yd_<?=$smaidx?>" data-sub-mater="<?=$smaidx?>" onblur="sub_mater_math(this)" value=""></td>
                                                    <td colspan = "2">
                                                        <select onfocus="Vail_fixed(this)" class="noborder jo_select per_select" name="jo_sub_mater_info_danga_per[<?=$smaidx?>]" id ="per_select_<?=$smaidx?>" data-sub-mater="<?=$smaidx?>">
                                                            <option value="">기본</option>
                                                            <option value="1.2">20%</option>
                                                        </select>    
                                    ...
                                    <tr class="btn-add-mater-price mater_price_1" data-item-idx=1 >
                                        ...
                                        <th colspan = "4">제품 매입 단가</th>
                                        <th colspan = "6"></th>
                                        <!-- <th colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_size[1]"  value="<?=$jo_maip_price[1]['size']?>"></th>
                                        <th><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[1]" id="jo_maip_price_hei_1" data-price-idx="1" onblur="yochek_cal1(this)" value="<?=$jo_maip_price[1]['hei']?>"></th>
                                        <th class="txt_center"></th>
                                        <th><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[1]" id="jo_maip_price_length_1" data-price-idx="1" onblur="yochek_cal1(this)" value="<?=$jo_maip_price[1]['length']?>"></th>
                                        <th><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_yd[1]" id="jo_maip_price_yd_1" data-price-idx="1" onblur="ex_temp4(this)" value="<?=$jo_maip_price[1]['yd']?>" ></th> -->
                                        <th colspan = "2">
                                            <select onfocus="Vail_fixed(this)" class="noborder jo_select exchange_select" name="jo_maip_price_danga_exchange[1]" id ="exchange_select_1" data-price-idx="1">
                                            ...
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_maip_price_danga[1]" id="jo_maip_price_danga_1" data-price-idx="1" onblur="ex_temp4(this)" value="<?=$jo_maip_price[1]['danga']?>">
                                        </th>
                                        <th><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[1]" id="jo_maip_price_price_1" data-price-idx="1" value="<?=$jo_maip_price[1]['price'] ? number_format($jo_maip_price[1]['price']) : ''?>"></th>
                                    </tr>
                                </table>
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan = "2" class="txt_right">
                                            ...
                                            <input onfocus="Vail_fixed(this)" class="noborder90 txt_right print_hidden" name="jo_maip_price_price[2]" id="jo_maip_price_price_2" data-price-idx="2"  onblur="temp4_unim()" value="<?=$jo_maip_price[2]['price'] ? $jo_maip_price[2]['price'] : ''?>">%
                                        </td>
                                        <th class="txt_right">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan = "2" class="txt_right">
                                            ...
                                            <input onfocus="Vail_fixed(this)" class="noborder90 txt_right print_hidden" name="jo_maip_price_price[3]" id="jo_maip_price_price_3" data-price-idx="3"  onblur="temp4_kanse()" value="<?=$jo_maip_price[3]['price'] ? $jo_maip_price[3]['price'] : ''?>">%
                                        </td>
                                        <th class="txt_right">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan = "2" class="txt_right">
                                            <input onfocus="Vail_fixed(this)" class="noborder90 txt_right print_hidden" name="jo_prod_control_price" id="jo_prod_control_price" onblur="prod_total_price()" value="<?=$jo['jo_prod_control_price'] <=0 ? $jo['jo_prod_control_price'] : 5?>">%
                                        </td>
                                        <th class="txt_right">
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            ...
                                            <input type="hidden" onfocus="Vail_fixed(this)" class="noborder_th txt_right func_th print_hidden" id ="jo_total_origin_price" name ="jo_total_origin_price" onblur="comma_input(this)" value ="<?=number_format($jo['jo_total_origin_price'])?>" >
                                        </th>
                                    </tr>
                                    <?
...
<script>
    ...
    $(document).ready(function(){
        ...
        //총원가 기입
        if (is_checked("function")) {
            if($('#jo_brand').val() == '쉐르단' || $('#jo_brand').val() == '랄프로렌홈'){
                if($('#jo_prod_year').val() < 2021 && $('#jo_prod_year').val() != ''){
                    $("#jo_total_origin_price").attr("type","");
                    $("#jo_total_origin_price_view").css("display","none");
                    $('#jo_total_origin_price').val(comma($("#jo_total_origin_price").val()+""));
                    
                }
            }else{
                $("#jo_total_origin_price").attr("type","hidden");
                $("#jo_total_origin_price_view").css("display","block");
            }
        }
        $('#jo_brand').change(function () {
            if (is_checked("function")) {
                if($('#jo_brand').val() == '쉐르단' || $('#jo_brand').val() == '랄프로렌홈'){
                    if($('#jo_prod_year').val() < 2021 && $('#jo_prod_year').val() != ''){
                        $("#jo_total_origin_price").attr("type","text");
                        $("#jo_total_origin_price_view").css("display","none");
                    }
                }else{
                    $("#jo_total_origin_price").attr("type","hidden");
