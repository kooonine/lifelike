...
//         "title" => $_POST['jo_codi_img_title'][$jci],
//         "img" => $jo_codi_img_img,
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="3">
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    ?>
                                        <tr class="btn-add-mater mater_1" data-item-idx=1 >
                                            ...
                                            <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_mater_info_title[1]" value="앞면/메인프린트"></td>
                                        ...
                                        <tr class="btn-add-mater mater_2" data-item-idx=2 >
                                            ...
                                            <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_mater_info_title[2]" value="뒷면/코디프린트"></td>
                                        ...
                                        <tr class="btn-add-mater mater_3" data-item-idx=3 >
                                            ...
                                            <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_mater_info_title[3]" value="라벨"></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_size[3]"  value="소프라움 직조"></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_hei[3]" id="jo_mater_info_hei_3" data-mater-idx="3" value=""></td>
                                            <td class="txt_center"></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_length[3]" id="jo_mater_info_length_3" data-mater-idx="3" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_yd[3]" id="jo_mater_info_yd_3" data-mater-idx="3" onblur="mater_math1(this)" value="" ></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_mater_info_danga[3]" id="jo_mater_info_danga_3" data-mater-idx="3"  onblur="mater_math1(this)" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[3]" id="jo_mater_info_price_3" data-mater-idx="3" onblur="mater_math1(this)" value=""></td>
                                        </tr>
                                    ...
                                    <?if($jm < 4):?>
                                        ...
                                        <?for($maidx = $cnt_mater; $maidx < 5 ; $maidx++) : ?>
                                    ...
                                    <tr class="btn-add-mater-price mater_price_1" data-item-idx=1 >
                                        ...
                                        <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[1]" value="<?=$jo_maip_price[1]['title'] ? $jo_maip_price[1]['title'] : '' ?>"></td>
                                        ...
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_yd[1]" id="jo_maip_price_yd_1" data-price-idx="1" onblur="ex_price_math1(this)" value="<?=$jo_maip_price[1]['yd']?>" ></td>
                                        <td colspan = "2">
                                            <select onfocus="Vail_fixed(this)" class="noborder jo_select exchange_select" name="jo_maip_price_danga_exchange[1]" id ="exchange_select_1" data-mater-idx="1">
                                                <option value="USD" <?= $jo_maip_price[1]['exchange'] == 'USD' ? "selected" : "" ?>>USD</option>
                                                <option value="CNY" <?= $jo_maip_price[1]['exchange'] == 'CNY' ? "selected" : "" ?>>CNY</option>
                                                <option value="JPY" <?= $jo_maip_price[1]['exchange'] == 'JPY' ? "selected" : "" ?>>JPY</option>
                                                <option value="EUR" <?= $jo_maip_price[1]['exchange'] == 'EUR' ? "selected" : "" ?>>EUR</option>
                                            </select>
                                            
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_maip_price_danga[1]" id="jo_maip_price_danga_1" data-price-idx="1" onblur="ex_price_math1(this)" value="<?=$jo_maip_price[1]['danga']?>">
                                        </td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[1]" id="jo_maip_price_price_1" data-price-idx="1" onblur="ex_price_math1(this)" value="<?=$jo_maip_price[1]['price'] ? number_format($jo_maip_price[1]['price']) : ''?>"></td>
                                    </tr>
                                    <tr class="btn-add-mater-price mater_price_2" data-item-idx=2 >
                                        ...
                                        <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[2]" value="<?=$jo_maip_price[2]['title'] ? $jo_maip_price[2]['title'] : '운임' ?>"></td>
                                        ...
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[2]" id="jo_maip_price_hei_2" data-price-idx="2"  value="<?=$jo_maip_price[2]['hei']?>"></td>
                                        <td class="txt_center"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[2]" id="jo_maip_price_length_2" data-price-idx="2"  value="<?=$jo_maip_price[2]['length']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder noborder80 print_hidden" name="jo_maip_price_yd[2]" id="jo_maip_price_yd_2" data-price-idx="2" onblur="unim_math1(this)" value="<?=$jo_maip_price[2]['yd']?>" >%</td>
                                        <td colspan = "2"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[2]" id="jo_maip_price_price_2" data-price-idx="2" onblur="unim_math1(this)" value="<?=$jo_maip_price[2]['price'] ? number_format($jo_maip_price[2]['price']) : ''?>"></td>
                                    </tr>
                                    <tr class="btn-add-mater-price mater_price_3" data-item-idx=3 >
                                        <td class="noline_left noline_top">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[3]">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_maip_price_no[3]" value = "3">
                                        </td>
                                        <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[3]" value="<?=$jo_maip_price[3]['title'] ? $jo_maip_price[3]['title'] : '관세' ?>"></td>
                                        <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_size[3]"  value="<?=stripslashes($jo_maip_price[3]['size'])?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[3]" id="jo_maip_price_hei_3" data-price-idx="3"  value="<?=$jo_maip_price[3]['hei']?>"></td>
                                        <td class="txt_center"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[3]" id="jo_maip_price_length_3" data-price-idx="3" value="<?=$jo_maip_price[3]['length']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder noborder80 print_hidden" name="jo_maip_price_yd[3]" id="jo_maip_price_yd_3" data-price-idx="3" onblur="kanse_math1(this)" value="<?=$jo_maip_price[3]['yd']?>" >%</td>
                                        <td colspan = "2"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[3]" id="jo_maip_price_price_3" data-price-idx="3" onblur="kanse_math1(this)" value="<?=$jo_maip_price[3]['price'] ? number_format($jo_maip_price[3]['price']) : ''?>"></td>
                                    </tr>
                                    <tr>
                                        <td class="noline_left noline_top dotted"></td>
                                        <th colspan = "12" >반제피 단가 (원단 원가 sum + 봉제공임 원가 +관세+운임)</th>
                                    ...
                                    <tr class="btn-add-mater-price mater_price_4" data-item-idx=4 >
                                        <td class="noline_left noline_top">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[4]">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_maip_price_no[4]" value = "1">
                                        </td>
                                        <td colspan = "6"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[4]" value="<?=$jo_maip_price[4]['title']?>"></td>
                                        <!-- <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_size[4]"  value="<?=$jo_maip_price[4]['size']?>"></td> -->
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[4]" id="jo_maip_price_hei_4" data-price-idx="4"  value="<?=$jo_maip_price[4]['hei']?>"></td>
                                        <td class="txt_center"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[4]" id="jo_maip_price_length_4" data-price-idx="4"  value="<?=$jo_maip_price[4]['length']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_yd[4]" id="jo_maip_price_yd_4" data-price-idx="4" onblur="mater_price_math(this)" value="<?=$jo_maip_price[4]['yd']?>" ></td>
                                        <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_maip_price_danga[4]" id="jo_maip_price_danga_4" data-price-idx="4" onblur="mater_price_math(this)" value="<?=$jo_maip_price[4]['danga']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[4]" id="jo_maip_price_price_4" data-price-idx="4" onblur="mater_price_math(this)" value="<?=$jo_maip_price[4]['price'] ? number_format($jo_maip_price[4]['price']) : ''?>"></td>
                                    </tr>
                                    <tr class="btn-add-mater-price mater_price_5" data-item-idx=5 >
                                        <td class="noline_left noline_top">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[5]">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_maip_price_no[5]" value = "2">
                                        </td>
                                        <td colspan = "6"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[5]" value="<?=$jo_maip_price[5]['title']?>"></td>
                                        <!-- <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_size[5]"  value="<?=$jo_maip_price[5]['size']?>"></td> -->
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[5]" id="jo_maip_price_hei_5" data-price-idx="5"  value="<?=$jo_maip_price[5]['hei']?>"></td>
                                        <td class="txt_center"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[5]" id="jo_maip_price_length_5" data-price-idx="5"  value="<?=$jo_maip_price[5]['length']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_yd[5]" id="jo_maip_price_yd_5" data-price-idx="5" onblur="mater_price_math(this)" value="<?=$jo_maip_price[5]['yd']?>" ></td>
                                        <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_maip_price_danga[5]" id="jo_maip_price_danga_5" data-price-idx="5" onblur="mater_price_math(this)" value="<?=$jo_maip_price[5]['danga']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[5]" id="jo_maip_price_price_5" data-price-idx="5" onblur="mater_price_math(this)" value="<?=$jo_maip_price[5]['price'] ? number_format($jo_maip_price[5]['price']) : ''?>"></td>
                                    </tr>
                                    <tr class="btn-add-mater-price mater_price_6" data-item-idx=6 >
                                        <td class="noline_left noline_top">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[6]">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_maip_price_no[6]" value = "3">
                                        </td>
                                        <td colspan = "6"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_maip_price_title[6]" value="<?=$jo_maip_price[6]['title']?>"></td>
                                        <!-- <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_size[6]"  value="<?=$jo_maip_price[6]['size']?>"></td> -->
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_hei[6]" id="jo_maip_price_hei_6" data-price-idx="6"  value="<?=$jo_maip_price[6]['hei']?>"></td>
                                        <td class="txt_center"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_length[6]" id="jo_maip_price_length_6" data-price-idx="6"  value="<?=$jo_maip_price[6]['length']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_maip_price_yd[6]" id="jo_maip_price_yd_6" data-price-idx="6" onblur="mater_price_math(this)" value="<?=$jo_maip_price[6]['yd']?>" ></td>
                                        <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_maip_price_danga[6]" id="jo_maip_price_danga_6" data-price-idx="6" onblur="mater_price_math(this)" value="<?=$jo_maip_price[6]['danga']?>"></td>
                                        <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_maip_price_price print_hidden" name="jo_maip_price_price[6]" id="jo_maip_price_price_6" data-price-idx="6" onblur="mater_price_math(this)" value="<?=$jo_maip_price[6]['price'] ? number_format($jo_maip_price[6]['price']) : ''?>"></td>
                                    </tr>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        <?else:?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[1]" value="소프라움 직조"></td>
                                                ...
                                                <td colspan = "2">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="50">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[1]" id="jo_sub_mater_info_price_1" data-sub-mater="1" onblur="sub_mater_math(this)" value="50"></td>
                                            </tr>
                            ...
                            <td id="noline_td" colspan = "17">
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="txt_left">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden" name="jo_mater_name_danga[1]" value="<?=$first_mater_name['danga']?>">
                                        </td>
                                        <td colspan="4"></td>
