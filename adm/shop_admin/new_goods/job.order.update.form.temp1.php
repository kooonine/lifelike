    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="1">
                ...
                <div class="a4" id = "print">
                    ...
                    <table id="new_goods_table" style="width : auto;" >
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <!-- <input class="noborder txt_center" type="text" name="jo_it_name" value="소프라운 국민구스 프라우덴 30배게"> -->
                                <?
                            ...
                            <td colspan="4" onclick="regDatePicker()">
                                <span style="position: relative;">
                                    <input onfocus="Vail_fixed(this)" type="text" name="jo_reg_date" value="<?php echo $it_reg_date ? $it_reg_date : date("Y-m-d"); ; ?>"  id="regdatepicker" required class="noborder txt_center" size="21" maxlength="19">
                        ...
                        <tr>
                            ...
                            <td rowspan="2" colspan="3">
                                <select onfocus="Vail_fixed(this)" name="jo_prod_name" id ="jo_prod_name" class="jo_select noborder 
                                <? if ($it_prod_type == '커버'):?>
                                     pum1
                        ...
                        <tr class="onedan_switch">
                            <td rowspan="2" colspan="3" class="txt_center">
                                <input onfocus="Vail_fixed(this)" type='file' name ="jo_main_img_img" id='verborgen_file_main' />
                                <div id="main_pf_foto">
                                    <?if($jo_main_img[1]['img']):?>
                                    <input onfocus="Vail_fixed(this)" type="hidden" name="jo_main_img_img[1]"  value="<?=$jo_main_img[1]['img']?>"> 
                                    <?endif?>
                            ...
                            <td rowspan="2" colspan="2" class="txt_center">
                                <input onfocus="Vail_fixed(this)" type='file' name ="jo_codi_img_img" id='verborgen_file_codi' />    
                                <div id="codi_pf_foto">
                                    <?if($jo_codi_img[1]['img']):?>
                                    <input onfocus="Vail_fixed(this)" type="hidden" name="jo_codi_img_img[1]"  value="<?=$jo_codi_img[1]['img']?>"> 
                                    <?endif?>
                            ...
                            <td rowspan="2" colspan="2" class="txt_center">
                            <input onfocus="Vail_fixed(this)" type='file' name ="jo_sub_img_img" id='verborgen_file_sub' />
                                <div id="sub_pf_foto">
                                    <?if($jo_sub_img[1]['img']):?>
                                    <input onfocus="Vail_fixed(this)" type="hidden" name="jo_sub_img_img[1]"  value="<?=$jo_sub_img[1]['img']?>"> 
                                    <?endif?>
                        ...
                        <tr>
                            <td rowspan="1"  colspan = "10" >
                                <input onfocus="Vail_fixed(this)" type='file' id="imgInp" name ="jo_design_img" />
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <?php foreach ($jo_mater_info as $jm => $mater_info) : ?>
                                        <tr class="btn-add-mater mater_<?=$jm?>" data-item-idx=<?=$jm?> >
                                            <td class="noline_left noline_top">
                                                <input class="noborder txt_left" type="hidden" name="jo_mater_info[<?=$jm?>]">
                                                <input class="noborder txt_left" type="hidden"name="jo_mater_info_no[<?=$jm?>]" value = "<?=$jm?>">
                                            </td>
                                    ...
                                    <?if($jm < 5):?>
                                        ...
                                        <?for($maidx = $cnt_mater; $maidx < 6 ; $maidx++) : ?>
                                            <tr class="btn-add-mater mater_<?=$maidx?>" data-item-idx=<?=$maidx?> >
                                                <td class="noline_left noline_top">
                                                    <input class="noborder txt_left" type="hidden" name="jo_mater_info[<?=$maidx?>]">
                                                    <input class="noborder txt_left" type="hidden"name="jo_mater_info_no[<?=$maidx?>]" value = "<?=$maidx?>">
                                                </td>
                                                ...
                                                <td colspan = "2"><input class="noborder txt_right print_hidden" name="jo_mater_info_danga[<?=$maidx?>]" id="jo_mater_info_danga_<?=$maidx?>" data-mater-idx="<?=$maidx?>" onblur="mater_math1(this)" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            ...
                                            <input onfocus="Vail_fixed(this)" type="hidden" class="noborder_th txt_right func_th print_hidden" onblur="comma_input(this)"  id ="total_mater_price" name ="total_mater_price" value ="<?=number_format($total_mater_price)?>" > 
                                        </th>
                                    </tr>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        <?php foreach ($jo_sub_mater as $jsm => $sub_mater) : ?>
                                            <tr class="btn-add-sub-mater sub-mater_<?=$jsm?>" data-item-idx=<?=$jsm?>>
                                                <td class="noline_left noline_top">
                                                    <input class="noborder txt_left" type="hidden" name="jo_sub_mater_info[<?=$jsm?>]">
                                                    <input class="noborder txt_left" type="hidden"name="jo_sub_mater_info_no[<?=$jsm?>]" value = "<?=$jsm?>">
                                                </td>
                                        ...
                                        <?else:?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                <td class="noline_left noline_top">
                                                    <input class="noborder txt_left" type="hidden" name="jo_sub_mater_info[1]">
                                                    <input class="noborder txt_left" type="hidden"name="jo_sub_mater_info_no[1]" value = "1">
                                                </td>
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[1]" value="소프라움 전사라벨"></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_size[1]" value="정상"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="330"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[1]" id="jo_sub_mater_info_price_1" data-sub-mater="1" onblur="sub_mater_math(this)" value="330"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_2" data-item-idx=2>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[2]" id="jo_sub_mater_info_danga_2" data-sub-mater="2" onblur="sub_mater_math(this)" value="380"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_3" data-item-idx=3>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_size[3]" value="패밀리"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[3]" id="jo_sub_mater_info_danga_3" data-sub-mater="3" onblur="sub_mater_math(this)" value="-"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_4" data-item-idx=4>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[4]" id="jo_sub_mater_info_danga_4" data-sub-mater="4" onblur="sub_mater_math(this)" value="80"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_5" data-item-idx=5>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[5]" id="jo_sub_mater_info_danga_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="42"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_6" data-item-idx=6>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[6]" value="가격택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[6]" id="jo_sub_mater_info_danga_6" data-sub-mater="6" onblur="sub_mater_math(this)" value="40"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[6]" id="jo_sub_mater_info_price_6" data-sub-mater="6" onblur="sub_mater_math(this)" value="40"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_7" data-item-idx=7>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[7]" value="품질보증택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[7]" id="jo_sub_mater_info_danga_7" data-sub-mater="7" onblur="sub_mater_math(this)" value="40"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_8" data-item-idx=8>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[8]" value="프라우덴 우모택"></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[8]" id="jo_sub_mater_info_price_8" data-sub-mater="8" onblur="sub_mater_math(this)" value="0"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_9" data-item-idx=9>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[9]" value="프라우덴 RDS 택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[9]" id="jo_sub_mater_info_danga_9" data-sub-mater="9" onblur="sub_mater_math(this)" value="-"></td>
                                            ...
                                            <tr class="btn-add-sub-mater sub-mater_10" data-item-idx=10>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[10]" value="알러지 방지택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[10]" id="jo_sub_mater_info_danga_10" data-sub-mater="10" onblur="sub_mater_math(this)" value="30"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[10]" id="jo_sub_mater_info_price_10" data-sub-mater="10" onblur="sub_mater_math(this)" value="30"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_11" data-item-idx=11>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[11]" value="베개가방"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[11]" id="jo_sub_mater_info_danga_11" data-sub-mater="11" onblur="sub_mater_math(this)" value="1,400"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[11]" id="jo_sub_mater_info_price_11" data-sub-mater="11" onblur="sub_mater_math(this)" value="1,400"></td>
                                            </tr>
                                        <?endif?>
                                    ...
                                    <tbody id="jo_gakong_item_area">
                                        ...
                                        <!-- <tr class="btn-add-gakong-item gakong-item_1" data-item-idx=1>
                                            <td class="noline_left noline_top">
                                                <input class="noborder txt_left" type="hidden" name="jo_gakong_item[1]">
                                                <input class="noborder txt_left" type="hidden"name="jo_gakong_item_no[1]" value = "1">
                                            </td>
                                            <td colspan = "4"><input class="noborder txt_left" name="jo_gakong_item_title[1]" value="봉제공임"></td>
                                            <td colspan = "2"></td>
                                            <td></td>
                                            <td class="txt_center"></td>
                                            <td></td>
                                            <td><input class="noborder" name="jo_gakong_item_yd[1]" value=""></td>
                                            <td colspan = "2"><input class="noborder txt_right" name="jo_gakong_item_danga[1]" value=""></td>
                                            <td><input class="noborder txt_right" name="jo_gakong_item_price[1]" value=""></td>
                                        </tr>
                                        <tr class="btn-add-gakong-item gakong-item_2" data-item-idx=2>
                                            <td class="noline_left noline_top">
                                                <input class="noborder txt_left" type="hidden" name="jo_gakong_item[2]">
                                                <input class="noborder txt_left" type="hidden"name="jo_gakong_item_no[2]" value = "2">
                                            </td>
                                            <td colspan = "4"><input class="noborder txt_left" name="jo_gakong_item_title[2]" value="주입공임"></td>
                                            <td colspan = "2"></td>
                                            <td></td>
                                            <td class="txt_center"></td>
                                            <td></td>
                                            <td><input class="noborder" name="jo_gakong_item_yd[2]" value=""></td>
                                            <td colspan = "2"><input class="noborder txt_right" name="jo_gakong_item_danga[2]" value=""></td>
                                            <td><input class="noborder txt_right" name="jo_gakong_item_price[2]" value=""></td>
                                        </tr>
                                        <tr class="btn-add-gakong-item gakong-item_3" data-item-idx=3>
                                            <td class="noline_left noline_top">
                                                <input class="noborder txt_left" type="hidden" name="jo_gakong_item[3]">
                                                <input class="noborder txt_left" type="hidden"name="jo_gakong_item_no[3]" value = "3">
                                            </td>
                                            <td colspan = "4"><input class="noborder txt_left" name="jo_gakong_item_title[3]" value="포장비"></td>
                                            <td colspan = "2"></td>
                                            <td></td>
                                            <td class="txt_center"></td>
                                            <td></td>
                                            <td><input class="noborder" name="jo_gakong_item_yd[3]" value=""></td>
                                            <td colspan = "2"><input class="noborder txt_right" name="jo_gakong_item_danga[3]" value=""></td>
                                            <td><input class="noborder txt_right" name="jo_gakong_item_price[3]" value=""></td>
                                        </tr> -->
                            ...
                            <td rowspan="1"  colspan = "10" id="hold_td_text_area" >
                                <div id="msg_area">
                                    ...
                                    <div id="print_img_area" style='display:flex; flex-wrap:wrap; justify-content:center; align-items:center;'>
                                        <input onfocus="Vail_fixed(this)" type='file' name ="jo_memo_img" id='verborgen_file_jo_memo_img' />
                            ...
                            <td id="noline_td" colspan = "17">
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            <!-- <input class="noborder txt_right txt_op1" name="jo_prod_origin_price" value="28,235"> -->
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            <!-- <input class="noborder txt_right" name="jo_total_origin_price" value="28,235"> -->
