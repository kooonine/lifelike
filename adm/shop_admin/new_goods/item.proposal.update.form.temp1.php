    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="ip_temp" value="1">
                ...
                <div class="a4" id = "print">
                    ...
                    <div id ="job_order_title">제품기획서</div>
                        ...
                        <table id="new_goods_table" style="width : 100%;" >
                            <colgroup>
                                <col width="97px"/>
                                <col width="178px"/>
                                <col width="107px"/>
                        ...
                        <table id="new_goods_table" style="width : auto;" >
                            ...
                            <tr>
                                <td colspan="10">
                                    <table id="noline_new_goods_table" style="min-width : 965px; width : 100%;">
                                        ...
                                        <?
                                            ...
                                            $jo_job_order_items2 = sql_query($jo_job_order_sql);
                                        ?>
                                        ...
                                        for ($vi = 0 ; $row_items = sql_fetch_array($jo_job_order_items); $vi++) {
                                            ...
                                            foreach($ip_job_orders as $ijo => $job_items){
                                                ...
                                                if($row_items['jo_id'] == $job_items['jo_id']){
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <input type="hidden" name="ip_job_orders[<?=$vi+1?>]" value = "<?=$vi+1?>" >
                                                            <input type="hidden" name="ip_job_orders_jo_id[<?=$vi+1?>]" id = "ip_job_orders_jo_id_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "<?=$row_items['jo_id']?>" >
                                                            <td><input type="hidden" name="ip_job_orders_item[<?=$vi+1?>]"  value = "<?=$row_items['jo_prod_name']?><?=$row_items['jo_size_code']?>" ><span id = "ip_job_orders_item_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=$row_items['jo_prod_name']?><?=$row_items['jo_size_code']?> <?=item_color_name($row_items['jo_color'])?></span></td>
                                                            <td><input type="hidden" name="ip_job_orders_price[<?=$vi+1?>]" id = "ip_job_orders_price_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "<?=$row_items['jo_total_origin_price']?>" ><span id = "ip_job_orders_price_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=number_format($row_items['jo_total_origin_price'])?></span></td>
                                                            <td><input class="noborder" name="ip_job_orders_tag[<?=$vi+1?>]" id = "ip_job_orders_tag_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_sale(this)" value="<?=number_format($job_items['tag'])?>"></td>
                                                            <td><input class="noborder80 txt_right" name="ip_job_orders_sale_rate[<?=$vi+1?>]" id = "ip_job_orders_sale_rate_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_sale(this)" value="<?=$job_items['sale_rate']?>">%</td>
                                                            <td><input type="hidden" name="ip_job_orders_sale[<?=$vi+1?>]" id = "ip_job_orders_sale_<?=$vi+1?>"  value = "<?=$job_items['sale']?>" ><span id = "ip_job_orders_sale_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=number_format($job_items['sale'])?></span></td>
                                                            <td><input class="noborder80 txt_right" name="ip_job_orders_majin_rate[<?=$vi+1?>]" id = "ip_job_orders_majin_rate_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_majin(this)" value="<?=$job_items['majin_rate']?>">%</td>
                                                            <td><input type="hidden" name="ip_job_orders_majin[<?=$vi+1?>]" id = "ip_job_orders_majin_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "<?=$job_items['majin']?>" ><span id = "ip_job_orders_majin_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=$job_items['majin']?>%</span></td>
                                                            <td><input class="noborder" name="ip_job_orders_prod_qty[<?=$vi+1?>]" id = "ip_job_orders_prod_qty_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"  onblur="about_total_price(this)" value="<?=$job_items['qty']?>"></td>
                                                            <td colspan="2"><input class="ip_total_items_price" type="hidden" name="ip_job_orders_total_price[<?=$vi+1?>]" id = "ip_job_orders_total_price_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"  value = "<?=$job_items['total_price']?>" ><span id = "ip_job_orders_total_price_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=number_format($job_items['total_price'])?></span></td>
                                                        </tr>                                                    
                                                    <?
                                                    $all_false = true;    
                                                }else{
                                                    ...
                                                    ?>
                                                        <!-- <tr>
                                                            <input type="hidden" name="ip_job_orders[<?=$vi+1?>]" value = "<?=$vi+1?>" >
                                                            <input type="hidden" name="ip_job_orders_jo_id[<?=$vi+1?>]" id = "ip_job_orders_jo_id_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "<?=$row_items['jo_id']?>" >
                                                            <td><input type="hidden" name="ip_job_orders_item[<?=$vi+1?>]"  value = "<?=$row_items['jo_prod_name']?><?=$row_items['jo_size_code']?>" ><span id = "ip_job_orders_item_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=$row_items['jo_prod_name']?><?=$row_items['jo_size_code']?></span></td>
                                                            <td><input type="hidden" name="ip_job_orders_price[<?=$vi+1?>]" id = "ip_job_orders_price_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "<?=$row_items['jo_total_origin_price']?>" ><span id = "ip_job_orders_price_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"><?=number_format($row_items['jo_total_origin_price'])?></span></td>
                                                            <td><input class="noborder" name="ip_job_orders_tag[<?=$vi+1?>]" id = "ip_job_orders_tag_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_sale(this)" value=""></td>
                                                            <td><input class="noborder80 txt_right" name="ip_job_orders_sale_rate[<?=$vi+1?>]" id = "ip_job_orders_sale_rate_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_sale(this)" value="">%</td>
                                                            <td><input type="hidden" name="ip_job_orders_sale[<?=$vi+1?>]" id = "ip_job_orders_sale_<?=$vi+1?>"  value = "" ><span id = "ip_job_orders_sale_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"></span></td>
                                                            <td><input class="noborder80 txt_right" name="ip_job_orders_majin_rate[<?=$vi+1?>]" id = "ip_job_orders_majin_rate_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" onblur="math_majin(this)" value="">%</td>
                                                            <td><input type="hidden" name="ip_job_orders_majin[<?=$vi+1?>]" id = "ip_job_orders_majin_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>" value = "" ><span id = "ip_job_orders_majin_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"></span></td>
                                                            <td><input class="noborder" name="ip_job_orders_prod_qty[<?=$vi+1?>]" id = "ip_job_orders_prod_qty_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"  onblur="about_total_price(this)" value=""></td>
                                                            <td colspan="2"><input class="ip_total_items_price" type="hidden" name="ip_job_orders_total_price[<?=$vi+1?>]" id = "ip_job_orders_total_price_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"  value = "" ><span id = "ip_job_orders_total_price_view_<?=$vi+1?>" data-orders-idx = "<?=$vi+1?>"></span></td>
                                                        </tr> -->
                                ...
                                <td colspan="3" id="hold_td_text_area2" >
                                    ...
                                    <!-- <textarea id="text-area" class="noborder txt_left" name="ip_etc"></textarea> -->
                                </td>
                            </tr>
                            ...
                            <tr style="height:auto !important;">
                                <td colspan="7">
                                    <div class="job_images" style="display : flex;">
                                        <div id="main_pf_foto">
                                            <div class="txt_center min-hei25"><?=$jo_main_img[1]['title']?></div>
                                        ...
                                        <div id="codi_pf_foto">
                                            <div class="txt_center min-hei25"><?=$jo_codi_img[1]['title']?></div>
                                        ...
                                        <div id="sub_pf_foto">
                                            <div class="txt_center min-hei25"><?=$jo_sub_img[1]['title']?></div>
                                            <?if($jo_sub_img[1]['img']):?>
