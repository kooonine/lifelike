    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="5">
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <?php foreach ($jo_mater_info as $jm => $mater_info) : ?>
                                        <tr class="btn-add-mater mater_<?=$jm?>" data-item-idx=<?=$jm?> >
                                            ...
                                            <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[<?=$jm?>]" id="jo_mater_info_price_<?=$jm?>" data-mater-idx="<?=$jm?>" onblur="mater_math1(this)" value="<?=$mater_info['price'] ? number_format($mater_info['price']) : ''?>"></td>
                                        </tr>
                                    <?php endforeach ?>
                                    <?else:
                                    $jm = 2;    
                                    ?>
                                        <tr class="btn-add-mater mater__1" data-item-idx=1>
                                            ...
                                            <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[1]" id="jo_mater_info_price_1" data-mater-idx="1" onblur="mater_math1(this)" value=""></td>
                                        </tr>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        <?php foreach ($jo_sub_mater as $jsm => $sub_mater) : ?>
                                            <tr class="btn-add-sub-mater sub-mater_<?=$jsm?>" data-item-idx=<?=$jsm?>>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[<?=$jsm?>]" id="jo_sub_mater_info_danga_<?=$jsm?>" data-sub-mater="<?=$jsm?>" onblur="sub_mater_math(this)" value="<?=$sub_mater['danga'] ? number_format((int)$sub_mater['danga']) : '-'?>"></td>
                                        ...
                                        <?else:?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hiddent" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="55"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[1]" id="jo_sub_mater_info_price_1" data-sub-mater="1" onblur="sub_mater_math(this)" value="55"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_2" data-item-idx=2>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[2]" id="jo_sub_mater_info_price_2" data-sub-mater="2" onblur="sub_mater_math(this)" value="50"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_3" data-item-idx=3>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[3]" id="jo_sub_mater_info_price_3" data-sub-mater="3" onblur="sub_mater_math(this)" value="40"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_4" data-item-idx=4>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[4]" id="jo_sub_mater_info_price_4" data-sub-mater="4" onblur="sub_mater_math(this)" value="40"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_5" data-item-idx=5>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[5]" value="이블끈(스냅)"></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[5]" id="jo_sub_mater_info_yd_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="16.0"></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[5]" id="jo_sub_mater_info_danga_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="150"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[5]" id="jo_sub_mater_info_price_5" data-sub-mater="5" onblur="sub_mater_math(this)" value="2,400"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_6" data-item-idx=6>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[6]" value="콘실지퍼"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[6]" id="jo_sub_mater_info_danga_6" data-sub-mater="6" onblur="sub_mater_math(this)" value="824"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[6]" id="jo_sub_mater_info_price_6" data-sub-mater="6" onblur="sub_mater_math(this)" value="827"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_7" data-item-idx=7>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[7]" value="포장백"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[7]" id="jo_sub_mater_info_danga_7" data-sub-mater="7" onblur="sub_mater_math(this)" value="140"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[7]" id="jo_sub_mater_info_price_7" data-sub-mater="7" onblur="sub_mater_math(this)" value="140"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_8" data-item-idx=8>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[8]" id="jo_sub_mater_info_price_8" data-sub-mater="8" onblur="sub_mater_math(this)" value=""></td>
                                            </tr>
                                    ...
                                    <tbody id="jo_gakong_item_area">
                                        ...
                                        <?php foreach ($jo_gakong_item as $jgi => $gakong_item) : ?>
                                            <tr class="btn-add-gakong-item gakong-item_<?=$jgi?>" data-item-idx=<?=$jgi?>>
                                                ...
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_gakong_item_title[<?=$jgi?>]" value="<?=$gakong_item['title']?>">
                                                </td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[<?=$jgi?>]" id ="jo_gakong_item_hei_<?=$jgi?>"  data-gakong-idx="<?=$jgi?>" onblur="yochek_gakong(this)" value="<?=$gakong_item['hei']?>"></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[<?=$jgi?>]" id ="jo_gakong_item_length_<?=$jgi?>"  data-gakong-idx="<?=$jgi?>" onblur="yochek_gakong(this)" value="<?=$gakong_item['length']?>"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[<?=$jgi?>]" id="jo_gakong_item_danga_<?=$jgi?>" data-gakong-idx="<?=$jgi?>" onblur="gakong_math(this)" value="<?=$gakong_item['danga'] ? number_format((int)$gakong_item['danga']) : '-'?>"></td>
                                        ...
                                        ?>
                                            <tr class="btn-add-gakong-item gakong-item_1" data-item-idx=1>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[1]" id ="jo_gakong_item_hei_1"  data-gakong-idx="1" onblur="yochek_gakong(this)" value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[1]" id ="jo_gakong_item_length_1" data-gakong-idx="1" onblur="yochek_gakong(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[1]" id="jo_gakong_item_yd_1" data-gakong-idx="1" onblur="gakong_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[1]" id="jo_gakong_item_danga_1" data-gakong-idx="1" onblur="gakong_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[1]" id="jo_gakong_item_price_1" data-gakong-idx="1" onblur="gakong_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_2" data-item-idx=2>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[2]" id ="jo_gakong_item_hei_2"  data-gakong-idx="2" onblur="yochek_gakong(this)" value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[2]" id ="jo_gakong_item_length_2" data-gakong-idx="2" onblur="yochek_gakong(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[2]" id="jo_gakong_item_yd_2" data-gakong-idx="2" onblur="gakong_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[2]" id="jo_gakong_item_danga_2" data-gakong-idx="2" onblur="gakong_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[2]" id="jo_gakong_item_price_2" data-gakong-idx="2" onblur="gakong_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_3" data-item-idx=3>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[3]" id ="jo_gakong_item_hei_3"  data-gakong-idx="3" onblur="yochek_gakong(this)" value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[3]" id ="jo_gakong_item_length_3" data-gakong-idx="3" onblur="yochek_gakong(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[3]" id="jo_gakong_item_yd_3" data-gakong-idx="3" onblur="gakong_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[3]" id="jo_gakong_item_danga_3" data-gakong-idx="3" onblur="gakong_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[3]" id="jo_gakong_item_price_3" data-gakong-idx="3" onblur="gakong_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_4" data-item-idx=4>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[4]" id ="jo_gakong_item_hei_4"  data-gakong-idx="4" onblur="yochek_gakong(this)" value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[4]" id ="jo_gakong_item_length_4" data-gakong-idx="4" onblur="yochek_gakong(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[4]" id="jo_gakong_item_yd_4" data-gakong-idx="4" onblur="gakong_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[4]" id="jo_gakong_item_danga_4" data-gakong-idx="4" onblur="gakong_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[4]" id="jo_gakong_item_price_4" data-gakong-idx="4" onblur="gakong_math(this)" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_5" data-item-idx=5>
                                                ...
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[5]" value="">
                                                </td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[5]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[5]" id ="jo_gakong_item_hei_5"  data-gakong-idx="5" onblur="yochek_gakong(this)" value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[5]" id ="jo_gakong_item_length_5" data-gakong-idx="5" onblur="yochek_gakong(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[5]" id="jo_gakong_item_yd_5" data-gakong-idx="5" onblur="gakong_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[5]" id="jo_gakong_item_danga_5" data-gakong-idx="5" onblur="gakong_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[5]" id="jo_gakong_item_price_5" data-gakong-idx="5" onblur="gakong_math(this)" value=""></td>
                                            </tr>
                                        ...
                                        <?
                                            ...
                                            <?for($giidx = $cnt_gakong; $giidx < 8 ; $giidx++) : ?>
                                                <tr class="btn-add-gakong-item gakong-item_<?=$giidx?>" data-item-idx=<?=$giidx?>>
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[<?=$giidx?>]" value="">
                                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="">
                                            ...
                                            <?if(!empty($lt_mater_cmp)) : ?>
                                                <select  class="mater_select mater_list_1 mater_select_name" onchange="mater_com_ch()" data-mat-sel = "1";  name="jo_mater_name_mater[1]" id="mater_select_name_1">
                ...
                <div class="x_content">
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            ...
                            <button class="btn btn_02" type="button btn-success" <?if(($jo['jo_price_fixed'] == '100') && ($aas['mb_dept'] != '상품MD팀' && $member['mb_id'] != 'sbs608')):?>disabled<?endif?> id="btn_submit">임시저장</button>
...
<ul class="contextmenu4">
  ...
  <li><a href="#" onclick="removeImg_sub()">코드1 프린트 삭제</a></li>
...
<script>
    ...
    function prod_total_price(){
        ...
        control_price = Math.floor(control_price);       

        $('#jo_prod_control_price_view').empty().html(comma(control_price+"") );
    ...
    function gakong_math(elem){
        ...
        if(wid != ""){
            ...
            let length = $('#jo_gakong_item_length_'+id).val().replace(/,/gi,'');
             yo =((size*length)/91.44) * 1.02 ;
            
            yo = Math.ceil(yo*10)/10;
        }else{
            yo = $('#jo_gakong_item_yd_'+id).val().replace(/,/gi,'');
        }
    ...
    function mater_math1(elem){
        ...
        yo = parseInt(yo * 100) / 100;
        yo = Math.ceil(yo*10)/10;
        
        if(yo == 0){
            yo = $('#jo_mater_info_yd_'+id).val().replace(/,/gi,'');
        }else{
            if(yo<0.1){yo = 0.1};
        }
