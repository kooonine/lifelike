...
$ps_id = $_GET['ps_id'];
$ps_reorder_id = $_GET['ps_reorder_id'];
...
$action_url = https_url('adm') . "/shop_admin/new_goods/reorder.prod.schedule.update.php";
$brands = array(
    '소프라움' => '소프라움',
    '쉐르단' => '쉐르단',
    '랄프로렌홈' => '랄프로렌홈',
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="x_title">
                    <h4><span class="fa fa-check-square"></span>
                    <?if ($w =='re') :?>
                        기존상품 리오더 생산일정 등록
                    <?else :?>
                        신상품 생산일정 등록
                        ...
                        <table id="compaign-content-wrapper" class="ng_table">
                            ...
                            <tbody>
                                <tr>
                                    <th>구분</th>
                                    <td>
                                        <input name="ps_gubun" id ="ps_gubun" value="<?=$w =='u' ? $ps['ps_gubun'] : ''?>">
                                    </td>
                                    <th>목표납기(제품기획)*</th>
                                    <td>
                                        <select name="ps_limit_date" required id ="ps_limit_date">
                                            <? foreach ($nabgis as $ng => $nabgi) : ?>
                                                <option value="<?= $ng ?>" <?= $w =='u' ?  ($ps['ps_limit_date'] == $ng ? "selected" : "") : '' ?>><?= $nabgi ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <th>SO (OK)</th>
                                    <td>
                                       <input name="ps_os" id ="ps_os" value="<?=$w =='u' ? $ps['ps_os'] : ''?>">
                                    </td>
                                    <th>브랜드</th>
                                    <td>
                                    ...
                                    <td>
                                        <select name="ps_prod_gubun" required id ="ps_prod_gubun">
                                            <? foreach ($prod_gubun as $gb => $prodgubun) : ?>
                                                <option value="<?= $gb ?>" <?= $w =='u' ? ($ps['ps_prod_gubun'] == $gb ? "selected" : "") : '' ?>><?= $prodgubun ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </td>
                                    <th>상품명</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?if($w == 're') : ?>
                                                <tr>
                                                    <td><input name="ps_size[1]" id ="ps_size_1" value=""></td>
                                                    <td><input name="ps_size_qty[1]" id ="ps_size_qty_1" value="" placeholder="수량"></td>
                                                </tr>
                                                <tr>
                                                    <td><input name="ps_size[2]" id ="ps_size_2" value=""></td>
                                                    <td><input name="ps_size_qty[2]" id ="ps_size_qty_2" value="" placeholder="수량"></td>
                                                </tr>
                                                <tr>
                                                    <td><input name="ps_size[3]" id ="ps_size_3" value=""></td>
                                                    <td><input name="ps_size_qty[3]" id ="ps_size_qty_3" value="" placeholder="수량"></td>
                                                </tr>
                                                <tr>
                                                    <td><input name="ps_size[4]" id ="ps_size_4" value=""></td>
                                                    <td><input name="ps_size_qty[4]" id ="ps_size_qty_4" value="" placeholder="수량"></td>
                                                </tr>
                                        <?else : ?>
                                            <?if(empty($ps_reorder_id)):?>
                                                <?
                                                $jo_sql ="select * from lt_job_order where ps_id ={$ps_id}";
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><input name="ps_size[<?=$jo?>]" id ="ps_size_<?=$jo?>" value="<?=$jo_row['jo_size']?>"></td>
                                                        <td><input name="ps_size_qty[<?=$jo?>]" id ="ps_size_qty_<?=$jo?>" value="" placeholder="수량"></td>
                                                    </tr>
                                                <?}?>
                                            <?else:?>
                                                <?
                                                $jo_sql ="select * from lt_job_order where ps_id ={$ps['ps_id']}";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php foreach ($ps_sizes as $si => $ps_size) : ?>
                                                            <?if ($jo_row['jo_size'] == $ps_size['size']) :?>
                                                                <td><input name="ps_size_qty[<?=$jo?>]" id ="ps_size_qty_<?=$jo?>" value="<?=$ps_size['qty']?>" placeholder="수량"></td>
                                                            <?endif?>
                                                        <?php endforeach ?>
                                                        <?endif?>
                                                    </tr>
                                ...
                                <tr>
                                    <th>코드</th>
                                    <td>
                                        <input name="ps_code" id ="ps_code" value="<?=$w =='u' ? $ps['ps_code'] : ''?>">
                                    </td>
                                    <th>업체명</th>
                                    <td>
                                    <?
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="position: relative;">
                                            <input type="text" name="ps_real_ipgo_date" value="<?php echo $ps['ps_real_ipgo_date']; ?>"  id="ps_real_ipgo_date" required class="frm_input required" size="21" maxlength="19">
                                            <i class="glyphicon glyphicon-calendar fa fa-calendar"  style="position: absolute;bottom: 2px;right: 10px;top: auto;cursor: pointer;"></i>
                                        </span>
                                    </td>
                                </tr>
