...
$jo_etc_img = array();
if (!empty($jo['jo_etc_img'])) {
    $jo_etc_img = json_decode($jo['jo_etc_img'], true);
}
...
$matT = "select * from lt_prod_schedule_balju_mater";
$matR = sql_query($matT);
$mater_tel = array();
if(!empty($matR)){
    for($mat = 0; $rowmat = sql_fetch_array($matR); $mat++){
        $mat_temp = array(  
            "no" => $rowmat['no'], 
            "name" => $rowmat['mater_name'], 
            "tel" => $rowmat['mater_tel']
            
        );
        $mater_tel[$mat] = $mat_temp;
    }   
}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form name="fwrite" id="fwrite" action="<?= $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="jo_temp" value="7">
                ...
                <div class="a4" id = "print">
                    ...
                    <table id="new_goods_table" style="width : auto;" >
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                if(!empty($create_type) && $create_type != 'copy'){
                                    ...
                                    if (!empty($be_jo['jo_etc_img'])) {
                                        $jo_etc_img = json_decode($be_jo['jo_etc_img'], true);
                                    }
                        ...
                        <tr>
                            ...
                            <td id="main_soje" colspan="<?=$jo_etc_img ? '2': '3' ?>" class="txt_center">
                            ...
                            <td id="codi_soje" colspan="2" class="txt_center">
                            ...
                            <td id="codi1_soje" colspan="2" class="txt_center">
                            ...
                            <td id="etc_soje" style="display : <?=$jo_etc_img ? '':'none'?>" colspan="1" class="txt_center">
                                <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_etc_img[1]">
                                <input onfocus="Vail_fixed(this)" class="noborder txt_center" name="jo_etc_img_title[1]" value="<?=stripslashes($jo_etc_img[1]['title'])?>">
                            </td>
                            
                        </tr>
                        <tr class="onedan_switch">
                            <td id="main_soje_a" rowspan="2" colspan="<?=$jo_etc_img ? '2': '3' ?>" class="txt_center">
                            ...
                            <td id="codi_soje_a" rowspan="2" colspan="2" class="txt_center">
                            ...
                            <td id="codi1_soje_a" rowspan="2" colspan="2" class="txt_center">
                            ...
                            <td id="etc_soje_a" style="display : <?=$jo_etc_img ? '':'none'?>" rowspan="2" colspan="1" class="txt_center">
                            <input type='file' name ="jo_etc_img_img" id='verborgen_file_etc' />
                                <div id="etc_pf_foto">
                                    <?if($jo_etc_img[1]['img']):?>
                                    <input type="hidden" name="jo_etc_img_img[1]"  value="<?=$jo_etc_img[1]['img']?>"> 
                                    <?endif?>
                                    <img style="margin: 0 auto; display: block;" id="etc_pf_foto_img" <?if($jo_etc_img[1]['img']):?> src="<?=G5_URL?>/data/new_goods/<?=$jo_etc_img[1]['img']?>" <?endif?>>
                                    <input onfocus="Vail_fixed(this)" class="noborder txt_center txt_op emptyImg" name="jo_etc_img_text[1]" value="<?=$jo_etc_img[1]['text']?>">
                                </div>
                            </td>
                        </tr>
                        <tr class="cahei">
                                ...
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <?php foreach ($jo_mater_info as $jm => $mater_info) : ?>
                                        <tr class="btn-add-mater mater_<?=$jm?>" data-item-idx=<?=$jm?> >
                                            ...
                                            <select class="mater_select" name="jo_mater_info_main[<?=$jm?>]">
                                                <option value = "" <?= $mater_info['main'] == '' ? "selected" : "" ?>>선택</option>
                                                <option value = "메인" <?= $mater_info['main'] == '메인' ? "selected" : "" ?>>메인</option>
                                                <option value = "코디" <?= $mater_info['main'] == '코디' ? "selected" : "" ?>>코디</option>
                                                <option value = "코디1" <?= $mater_info['main'] == '코디1' ? "selected" : "" ?>>코디1</option>
                                                <option class="etc_soje" style="display : <?=$jo_etc_img ? '' : 'none'?>" value = "안감" <?= $mater_info['main'] == '안감' ? "selected" : "" ?>>안감</option>
                                            </select>
                                            <select class="mater_select" name="jo_mater_info_bongje[<?=$jm?>]">
                                                <option value = "" <?= $mater_info['bongje'] == '' ? "selected" : "" ?>>선택</option>
                                                <option value = "퀼팅" <?= $mater_info['bongje'] == '퀼팅' ? "selected" : "" ?>>퀼팅</option>
                                                <option value = "원헤드" <?= $mater_info['bongje'] == '원헤드' ? "selected" : "" ?>>원헤드</option>
                                                <option value = "봉제" <?= $mater_info['bongje'] == '봉제' ? "selected" : "" ?>>봉제</option>
                                            </select>
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_mater_info_title[<?=$jm?>]" value="<?=$mater_info['title']?>">
                                            </td>
                                            ...
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_hei[<?=$jm?>]" id="jo_mater_info_hei_<?=$jm?>" data-mater-idx="<?=$jm?>" onblur="yochek_cal1(this)" value="<?=$mater_info['hei']?>"></td>
                                            <td class="txt_center">x</td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_length[<?=$jm?>]" id="jo_mater_info_length_<?=$jm?>" data-mater-idx="<?=$jm?>" onblur="yochek_cal1(this)" value="<?=$mater_info['length']?>"></td>
                                            ...
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_mater_info_danga[<?=$jm?>]" id="jo_mater_info_danga_<?=$jm?>" data-mater-idx="<?=$jm?>" onblur="mater_math1(this)" value="<?=$mater_info['danga'] ? number_format($mater_info['danga']): ''?>"></td>
                                    ...
                                    $jm = 2;    
                                    ?>
                                        <tr class="btn-add-mater mater__1" data-item-idx=1>
                                            <td class="noline_left noline_top">
                                            ...
                                            <td colspan = "4" style="text-align : left;">
                                            <select class="mater_select" name="jo_mater_info_main[1]">
                                                <option value = "">선택</option>
                                                <option value = "메인">메인</option>
                                                <option value = "코디">코디</option>
                                                <option value = "코디1">코디1</option>
                                                <option class="etc_soje" value = "안감">안감</option>
                                            </select>
                                            <select class="mater_select" name="jo_mater_info_bongje[1]">
                                                <option value = "">선택</option>
                                                <option value = "퀼팅">퀼팅</option>
                                                <option value = "원헤드">원헤드</option>
                                                <option value = "봉제">봉제</option>
                                            </select>
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_mater_info_title[1]" value=""></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_size[1]" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_hei[1]" id="jo_mater_info_hei_1" data-mater-idx="1" onblur="yochek_cal1(this)" value=""></td>
                                            <td>x</td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_length[1]" id="jo_mater_info_length_1" data-mater-idx="1" onblur="yochek_cal1(this)" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_yd[1]" id="jo_mater_info_yd_1" data-mater-idx="1" onblur="mater_math1(this)" value=""></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" id="jo_mater_info_danga_1" data-mater-idx="1" onblur="mater_math1(this)" name="jo_mater_info_danga[1]" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[1]" id="jo_mater_info_price_1" data-mater-idx="1" value=""></td>
                                        </tr>
                                        <tr class="btn-add-mater mater__2" data-item-idx=2>
                                            <td class="noline_left noline_top">
                                            ...
                                            <td colspan = "4" style="text-align : left;">
                                            <select class="mater_select" name="jo_mater_info_main[2]">
                                                <option value = "">선택</option>
                                                <option value = "메인">메인</option>
                                                <option value = "코디">코디</option>
                                                <option value = "코디1">코디1</option>
                                            ...
                                            <select class="mater_select" name="jo_mater_info_bongje[2]">
                                                <option value = "">선택</option>
                                                <option value = "퀼팅">퀼팅</option>
                                                <option value = "원헤드">원헤드</option>
                                                <option value = "봉제">봉제</option>
                                            </select>
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_mater_info_title[2]" value=""></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_size[2]" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_hei[2]" id="jo_mater_info_hei_2" data-mater-idx="2" onblur="yochek_cal1(this)" value=""></td>
                                            <td>x</td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_length[2]" id="jo_mater_info_length_2" data-mater-idx="2" onblur="yochek_cal1(this)" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_mater_info_yd[2]" id="jo_mater_info_yd_2" data-mater-idx="2" onblur="mater_math1(this)" value=""></td>
                                            <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" id="jo_mater_info_danga_2" data-mater-idx="2" onblur="mater_math1(this)" name="jo_mater_info_danga[2]" value=""></td>
                                            <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[2]" id="jo_mater_info_price_2" data-mater-idx="2" value=""></td>
                                        </tr>
                                    <?endif?>
                                    <?if($jm < 5):?>
                                        <?
                                        ...
                                        <?for($maidx = $cnt_mater; $maidx < 6 ; $maidx++) : ?>
                                            <tr class="btn-add-mater mater_<?=$maidx?>" data-item-idx=<?=$maidx?> >
                                                ...
                                                <td colspan = "4" style="text-align : left;">
                                                <select class="mater_select" name="jo_mater_info_main[<?=$maidx?>]">
                                                    <option value = "">선택</option>
                                                    <option value = "메인">메인</option>
                                                    <option value = "코디">코디</option>
                                                    <option value = "코디1">코디1</option>
                                                ...
                                                <select class="mater_select" name="jo_mater_info_bongje[<?=$maidx?>]">
                                                    <option value = "">선택</option>
                                                    <option value = "퀼팅">퀼팅</option>
                                                    <option value = "원헤드">원헤드</option>
                                                    <option value = "봉제">봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_mater_info_title[<?=$maidx?>]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_mater_info_price print_hidden" name="jo_mater_info_price[<?=$maidx?>]" id="jo_mater_info_price_<?=$maidx?>" value=""></td>
                                            </tr>
                                        <?endfor?>
                                    <?endif?>
                                    </tbody>
                                    ...
                                    <tbody id="jo_sub_mater_info_area">
                                        ...
                                        <?php foreach ($jo_sub_mater as $jsm => $sub_mater) : ?>
                                            <tr class="btn-add-sub-mater sub-mater_<?=$jsm?>" data-item-idx=<?=$jsm?>>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[<?=$jsm?>]" id="jo_sub_mater_info_danga_<?=$jsm?>" data-sub-mater="<?=$jsm?>" onblur="sub_mater_math(this)" value="<?=(int)$sub_mater['danga'] ? number_format((int)$sub_mater['danga']) : '-'?>"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[<?=$jsm?>]" id="jo_sub_mater_info_price_<?=$jsm?>" data-sub-mater="<?=$jsm?>" value="<?=$sub_mater['price'] ? number_format($sub_mater['price']) : '0'?>"></td>
                                            </tr>
                                        <?php endforeach ?>
                                        <?else:?>
                                            <tr class="btn-add-sub-mater sub-mater_1" data-item-idx=1>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[1]" value="메인라벨(소프라움 직조)"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" id="jo_sub_mater_info_danga_1" data-sub-mater="1" onblur="sub_mater_math(this)" name="jo_sub_mater_info_danga[1]" value="55"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[1]" id="jo_sub_mater_info_price_1" data-sub-mater="1" value="55"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_2" data-item-idx=2>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[2]" value="품질표시라벨"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[2]" id="jo_sub_mater_info_danga_2" data-sub-mater="2" onblur="sub_mater_math(this)" value="50"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[2]" id="jo_sub_mater_info_price_2" data-sub-mater="2" value="50"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_3" data-item-idx=3>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[3]" value="품질보증택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[3]" id="jo_sub_mater_info_danga_3" data-sub-mater="3" onblur="sub_mater_math(this)" value="40"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[3]" id="jo_sub_mater_info_price_3" data-sub-mater="3" value="40"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_4" data-item-idx=4>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[4]" value="가격택"></td>
                                                ...
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[4]" id="jo_sub_mater_info_danga_4" data-sub-mater="4" onblur="sub_mater_math(this)" value="40"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[4]" id="jo_sub_mater_info_price_4" data-sub-mater="4" value="40"></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_5" data-item-idx=5>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[5]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[5]" id="jo_sub_mater_info_yd_5" data-sub-mater="5" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[5]" id="jo_sub_mater_info_danga_5" data-sub-mater="5" onblur="sub_mater_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[5]" id="jo_sub_mater_info_price_5" data-sub-mater="5" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_6" data-item-idx=6>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[6]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[6]" id="jo_sub_mater_info_yd_6" data-sub-mater="6" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[6]" id="jo_sub_mater_info_danga_6" data-sub-mater="6" onblur="sub_mater_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[6]" id="jo_sub_mater_info_price_6" data-sub-mater="6" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_7" data-item-idx=7>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[7]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[7]" id="jo_sub_mater_info_yd_7" data-sub-mater="7" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[7]" id="jo_sub_mater_info_danga_7" data-sub-mater="7" onblur="sub_mater_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[7]" id="jo_sub_mater_info_price_7" data-sub-mater="7" value=""></td>
                                            </tr>
                                            <tr class="btn-add-sub-mater sub-mater_8" data-item-idx=8>
                                                ...
                                                <td colspan = "4"><input onfocus="Vail_fixed(this)" class="noborder txt_left" name="jo_sub_mater_info_title[8]" value=""></td>
                                                ...
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[8]" id="jo_sub_mater_info_yd_8" data-sub-mater="8" onblur="sub_mater_math(this)" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_sub_mater_info_danga[8]" id="jo_sub_mater_info_danga_8" data-sub-mater="8" onblur="sub_mater_math(this)" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_sub_mater_info_price print_hidden" name="jo_sub_mater_info_price[8]" id="jo_sub_mater_info_price_8" data-sub-mater="8" value=""></td>
                                            </tr>
                                    ...
                                    <tbody id="jo_gakong_item_area">
                                        ...
                                        <?php foreach ($jo_gakong_item as $jgi => $gakong_item) : ?>
                                            <tr class="btn-add-gakong-item gakong-item_<?=$jgi?>" data-item-idx=<?=$jgi?>>
                                                ...
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[<?=$jgi?>]">
                                                    <option value = "" <?= $gakong_item['bongje'] == '' ? "selected" : "" ?>>선택</option>
                                                    <option value = "가공비_퀼팅" <?= $gakong_item['bongje'] == '가공비_퀼팅' ? "selected" : "" ?>>가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드" <?= $gakong_item['bongje'] == '가공비_원헤드' ? "selected" : "" ?>>가공비_원헤드</option>
                                                    <option value = "가공비_봉제" <?= $gakong_item['bongje'] == '가공비_봉제' ? "selected" : "" ?>>가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[<?=$jgi?>]" value="<?=$gakong_item['title']?>"></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_size[<?=$jgi?>]" value="<?=stripslashes($gakong_item['size'])?>"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[<?=$jgi?>]" id ="jo_gakong_item_hei_<?=$jgi?>"  data-gakong-idx="<?=$jgi?>"  value="<?=$gakong_item['hei']?>"></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[<?=$jgi?>]" id ="jo_gakong_item_length_<?=$jgi?>"  data-gakong-idx="<?=$jgi?>"  value="<?=$gakong_item['length']?>"></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[<?=$jgi?>]" id="jo_gakong_item_yd_<?=$jgi?>" data-gakong-idx="<?=$jgi?>" value="<?=$gakong_item['yd']?>"></td>
                                                <?if($jgi == 1):?>
                                                    <td colspan = "2">
                                                        <select onfocus="Vail_fixed(this)" class="noborder jo_select exchange_select" name="jo_gakong_item_danga_exchange[1]" id ="exchange_select_1"  data-gakong-idx="1">
                                                            <option value="USD" <?= $gakong_item['exchange'] == 'USD' ? "selected" : "" ?>>USD</option>
                                                            <option value="CNY" <?= $gakong_item['exchange'] == 'CNY' ? "selected" : "" ?>>CNY</option>
                                                            <option value="JPY" <?= $gakong_item['exchange'] == 'JPY' ? "selected" : "" ?>>JPY</option>
                                                            <option value="EUR" <?= $gakong_item['exchange'] == 'EUR' ? "selected" : "" ?>>JPY</option>
                                                        </select>
                                                        <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_gakong_item_danga[<?=$jgi?>]" id="jo_gakong_item_danga_<?=$jgi?>" data-gakong-idx="<?=$jgi?>"  onblur="ex_gakong_math(this)"  value="<?=$gakong_item['danga']?>">
                                                    </td>    
                                                <?else:?>    
                                                    <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[<?=$jgi?>]" id="jo_gakong_item_danga_<?=$jgi?>" data-gakong-idx="<?=$jgi?>"  value="<?=$gakong_item['danga'] ? number_format($gakong_item['danga']) : '-'?>"></td>
                                                <?endif?>    

                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[<?=$jgi?>]" id="jo_gakong_item_price_<?=$jgi?>" data-gakong-idx="<?=$jgi?>"  value="<?=$gakong_item['price'] ? number_format($gakong_item['price']) : '0'?>"></td>
                                            </tr>
                                        ...
                                        ?>
                                            <tr class="btn-add-gakong-item gakong-item_1" data-item-idx=1>
                                                ...
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[1]">
                                                    <option value = "">선택</option>
                                                    <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드">가공비_원헤드</option>
                                                    <option value = "가공비_봉제">가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[1]" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[1]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[1]" id ="jo_gakong_item_hei_1"  data-gakong-idx="1"  value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[1]" id ="jo_gakong_item_length_1" data-gakong-idx="1"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[1]" id="jo_gakong_item_yd_1" data-gakong-idx="1" value=""></td>
                                                <td colspan = "2">
                                                    <select onfocus="Vail_fixed(this)" class="noborder jo_select exchange_select" name="jo_gakong_item_danga_exchange[1]" id ="exchange_select_1"  data-gakong-idx="1">
                                                    ...
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_right exchange_input print_hidden" name="jo_gakong_item_danga[1]" id="jo_gakong_item_danga_1" data-gakong-idx="1" onblur="ex_gakong_math(this)" value="">
                                                </td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[1]" id="jo_gakong_item_price_1" data-gakong-idx="1" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_2" data-item-idx=2>
                                                ...
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[2]">
                                                    <option value = "">선택</option>
                                                    <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드">가공비_원헤드</option>
                                                    <option value = "가공비_봉제">가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[2]" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[2]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[2]" id ="jo_gakong_item_hei_2"  data-gakong-idx="2"  value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[2]" id ="jo_gakong_item_length_2" data-gakong-idx="2"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[2]" id="jo_gakong_item_yd_2" data-gakong-idx="2"  value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[2]" id="jo_gakong_item_danga_2" data-gakong-idx="2"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[2]" id="jo_gakong_item_price_2" data-gakong-idx="2" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_3" data-item-idx=3>
                                                ...
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[3]">
                                                    <option value = "">선택</option>
                                                    <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드">가공비_원헤드</option>
                                                    <option value = "가공비_봉제">가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[3]" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[3]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[3]" id ="jo_gakong_item_hei_3"  data-gakong-idx="3"  value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[3]" id ="jo_gakong_item_length_3" data-gakong-idx="3"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[3]" id="jo_gakong_item_yd_3" data-gakong-idx="3"  value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[3]" id="jo_gakong_item_danga_3" data-gakong-idx="3"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[3]" id="jo_gakong_item_price_3" data-gakong-idx="3" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_4" data-item-idx=4>
                                                <td class="noline_left noline_top">
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_gakong_item[4]">
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_gakong_item_no[4]" value = "4">
                                                </td>
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[4]">
                                                    <option value = "">선택</option>
                                                    <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드">가공비_원헤드</option>
                                                    <option value = "가공비_봉제">가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[4]" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[4]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[4]" id ="jo_gakong_item_hei_4"  data-gakong-idx="4"  value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[4]" id ="jo_gakong_item_length_4" data-gakong-idx="4"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[4]" id="jo_gakong_item_yd_4" data-gakong-idx="4"  value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[4]" id="jo_gakong_item_danga_4" data-gakong-idx="4"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[4]" id="jo_gakong_item_price_4" data-gakong-idx="4" value=""></td>
                                            </tr>
                                            <tr class="btn-add-gakong-item gakong-item_5" data-item-idx=5>
                                                <td class="noline_left noline_top">
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_gakong_item[5]">
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden"name="jo_gakong_item_no[5]" value = "5">
                                                </td>
                                                <td colspan = "4">
                                                <select class="mater_select" name="jo_gakong_item_bongje[5]">
                                                    <option value = "">선택</option>
                                                    <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                    <option value = "가공비_원헤드">가공비_원헤드</option>
                                                    <option value = "가공비_봉제">가공비_봉제</option>
                                                </select>
                                                <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[5]" value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[5]" value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[5]" id ="jo_gakong_item_hei_5"  data-gakong-idx="5"  value=""></td>
                                                <td class="txt_center">x</td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[5]" id ="jo_gakong_item_length_5" data-gakong-idx="5"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_yd[5]" id="jo_gakong_item_yd_5" data-gakong-idx="5"  value=""></td>
                                                <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right print_hidden" name="jo_gakong_item_danga[5]" id="jo_gakong_item_danga_5" data-gakong-idx="5"  value=""></td>
                                                <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[5]" id="jo_gakong_item_price_5" data-gakong-idx="5" value=""></td>
                                            </tr>
                                        ...
                                        <?
                                            ...
                                            <?for($giidx = $cnt_gakong; $giidx < 8 ; $giidx++) : ?>
                                                <tr class="btn-add-gakong-item gakong-item_<?=$giidx?>" data-item-idx=<?=$giidx?>>
                                                    ...
                                                    <td colspan = "4">
                                                    <select class="mater_select" name="jo_gakong_item_bongje[<?=$giidx?>]">
                                                        <option value = "">선택</option>
                                                        <option value = "가공비_퀼팅">가공비_퀼팅</option>
                                                        <option value = "가공비_원헤드">가공비_원헤드</option>
                                                        <option value = "가공비_봉제">가공비_봉제</option>
                                                    </select>
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[<?=$giidx?>]" value=""></td>
                                                    <td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_size[<?=$giidx?>]" value=""></td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_hei[<?=$giidx?>]" id ="jo_gakong_item_hei_<?=$giidx?>"  data-gakong-idx="<?=$giidx?>" onblur="yochek_gakong(this)" value=""></td>
                                                    <td class="txt_center">x</td>
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder " name="jo_gakong_item_length[<?=$giidx?>]" id ="jo_gakong_item_length_<?=$giidx?>" data-gakong-idx="<?=$giidx?>" onblur="yochek_gakong(this)" value=""></td>
                                                    ...
                                                    <td><input onfocus="Vail_fixed(this)" class="noborder txt_right jo_gakong_item_price print_hidden" name="jo_gakong_item_price[<?=$giidx?>]" id="jo_gakong_item_price_<?=$giidx?>" data-gakong-idx="<?=$giidx?>" value=""></td>
                                                </tr>
                                            <?endfor?>
                                        <?endif?>
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            ...
                                            <input type="hidden" class="noborder_th txt_right func_th print_hidden" id ="total_gakong_price" name ="total_gakong_price" onblur="comma_input(this)" value ="<?=number_format($total_gakong_price)?>" >
                                        </th>
                                    </tr>
                                </table>
                        ...
                        <tr class="memo_info_aera">
                            ...
                            <td id="noline_td" colspan = "14">
                                <table id="noline_new_goods_table" style="width : 100%;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <th colspan = "10" class="txt_left"> 운임 </th>
                                        <td colspan = "2" class="txt_right">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[2]">
                                            <input onfocus="Vail_fixed(this)" class="noborder90 txt_right print_hidden" name="jo_maip_price_price[2]" id="jo_maip_price_price_2" data-price-idx="2"  onblur="temp4_unim()" value="<?=$jo_maip_price[2]['price'] ? $jo_maip_price[2]['price'] : 5?>">%
                                        </td>
                                        <th class="txt_right">
                                            <span class="print_hidden" id ="jo_maip_price_price_2_view"></span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <th colspan = "10" class="txt_left"> 관세 </th>
                                        <td colspan = "2" class="txt_right">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left" type="hidden" name="jo_maip_price[3]">
                                            <input onfocus="Vail_fixed(this)" class="noborder90 txt_right print_hidden" name="jo_maip_price_price[3]" id="jo_maip_price_price_3" data-price-idx="3"  onblur="temp4_kanse()" value="<?=$jo_maip_price[3]['price'] != "" ? $jo_maip_price[3]['price'] : 4.8?>">%
                                        </td>
                                        <th class="txt_right">
                                            <span class="print_hidden" id ="jo_maip_price_price_3_view"></span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="txt_right">
                                            ...
                                            <input class="noborder_th txt_right func_th print_hidden" type="hidden" id ="jo_total_origin_price" name ="jo_total_origin_price" onblur="comma_input(this)" value ="<?=number_format($jo['jo_total_origin_price'])?>" >
                                        </th>
                                    </tr>
                                    <?
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="4">구입처</th>
                                        <td colspan="5" class="">
                                            <? $chk_list_mater_1 = false;?>
                                            <?
                                                $mater_cmp = "select * from lt_prod_schedule_balju_mater";
                                                $lt_mater_cmp = sql_query($mater_cmp);
                                                $mater_cmp_arr = sql_fetch_array($mater_cmp);
                                            ?>
                                            <?if(!empty($lt_mater_cmp)) : ?>
                                                <select  class="mater_select mater_list_1 mater_select_name" data-mat-sel = "1";  name="jo_mater_name_mater[1]" id="mater_select_name_1">
                                                <? for ($lmc = 0 ;  $row_cmp = sql_fetch_array($lt_mater_cmp); $lmc ++) { 
                                                    if($row_cmp['mater_name'] == $first_mater_name['mater']){
                                                        $chk_list_mater_1 = true;
                                                    }
                                                ?>
                                                    <option class="" value="<?= $row_cmp['mater_name'] ?>" <?= $first_mater_name['mater'] == $row_cmp['mater_name'] ? "selected" : "" ?>><?= $row_cmp['mater_name'] ?></option>
                                                <?php } ?>
                                                    <option value = "" <?= $chk_list_mater_1 ? '' : 'selected' ?>>기타</option>
                                                </select>
                                            <?endif?> 

                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden <?= $chk_list_mater_1 ? 'select_sell' : '' ?>" id="mater_input_name_1" name="jo_mater_name_mater[1]" value="<?=$first_mater_name['mater']?>">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="txt_left">
                                            <input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden" name="jo_mater_name_danga[1]" value="<?=strpos($first_mater_name['danga'],',') ? $first_mater_name['danga'] :  number_format($first_mater_name['danga'])?>">
                                        </td>
                                        <td colspan="4"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <th colspan="4">연락처</th>
                                        <td colspan="5" class="mater_tel_1">
                                    ...
                                    <tbody id="jo_mater_name_area">
                                        <?if(!empty($jo_mater_name_item)) : ?>
                                            ...
                                            <tr class="btn-add-name-mater mater-name_<?=$jmni+2?>"  data-item-idx=<?=$jmni+2?>>
                                                ...
                                                <th colspan="4">구입처</th>
                                                <td colspan="5">
                                                <? $chk_list_mater = false;?>
                                                    <?
                                                        $mater_cmp_a = "select * from lt_prod_schedule_balju_mater";
                                                        $lt_mater_cmp_a = sql_query($mater_cmp_a);
                                                    ?>
                                                    <?if(!empty($lt_mater_cmp_a)) : ?>
                                                        <select  class="mater_select mater_list_<?=$jmni+2?> mater_select_name" data-mat-sel = "<?=$jmni+2?>";  name="jo_mater_name_mater[<?=$jmni+2?>]" id="mater_select_name_<?=$jmni+2?>">
                                                        <? for ($lmc2 = 0 ;  $row_cmp2 = sql_fetch_array($lt_mater_cmp_a); $lmc2 ++) { 
                                                            if($row_cmp2['mater_name'] == $mater_name_item['mater']){
                                                                $chk_list_mater = true;
                                                            }
                                                        ?>
                                                            <option class="" value="<?= $row_cmp2['mater_name'] ?>" <?= $mater_name_item['mater'] == $row_cmp2['mater_name'] ? "selected" : "" ?>><?= $row_cmp2['mater_name'] ?></option>
                                                        <?php } ?>
                                                            <option value = "" <?= $chk_list_mater ? '' : 'selected' ?>>기타</option>
                                                        </select>
                                                    <?endif?> 
                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden <?= $chk_list_mater ? 'select_sell' : '' ?>" name="jo_mater_name_mater[<?=$jmni+2?>]" id="mater_input_name_<?=$jmni+2?>" value="<?=$mater_name_item['mater']?>">
                                            ...
                                            <tr class="btn-add-name-mater mater-name_<?=$jmni+2?>"  data-item-idx=<?=$jmni+2?>>
                                                <td></td>
                                                <th colspan="4">연락처</th>
                                                <td colspan="5" class="mater_tel_<?=$jmni+2?>">
                                        ...
                                        <?else:?>
                                            ...
                                            <tr class="btn-add-name-mater"  data-item-idx=2>
                                                ...
                                                <th colspan="4">구입처</th>
                                                <td colspan="5">
                                                    <? $chk_list_mater_2 = false;?>
                                                    <?
                                                        $mater_cmp = "select * from lt_prod_schedule_balju_mater";
                                                        $lt_mater_cmp = sql_query($mater_cmp);
                                                    ?>
                                                    <?if(!empty($lt_mater_cmp)) : ?>
                                                        <select  class="mater_select mater_list_2 mater_select_name" data-mat-sel = "2";  name="jo_mater_name_mater[2]" id="mater_select_name_1">
                                                        <? for ($lmc = 0 ;  $row_cmp = sql_fetch_array($lt_mater_cmp); $lmc ++) { 
                                                            if($row_cmp['mater_name'] == $first_mater_name['mater']){
                                                                $chk_list_mater_2 = true;
                                                            }
                                                        ?>
                                                            <option class="" value="<?= $row_cmp['mater_name'] ?>" <?= $first_mater_name['mater'] == $row_cmp['mater_name'] ? "selected" : "" ?>><?= $row_cmp['mater_name'] ?></option>
                                                        <?php } ?>
                                                            <option value = "" <?= $chk_list_mater_2 ? '' : 'selected' ?>>기타</option>
                                                        </select>
                                                    <?endif?> 

                                                    <input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden <?= $chk_list_mater_2 ? 'select_sell' : '' ?>" id="mater_input_name_2" name="jo_mater_name_mater[2]" value="">
                                                </td>
                                                <td colspan="4">
                                            ...
                                            <tr class="btn-add-name-mater"  data-item-idx=2>
                                                <td></td>
                                                <th colspan="4">연락처</th>
                                                <td colspan="5" class="mater_tel_2">
...
<ul class="contextmenu4">
  ...
  <li><a href="#" onclick="removeImg_sub()">코디1 프린트 삭제</a></li>
  <li><a href="#" onclick="removeImg_etc()">안감 프린트 삭제</a></li>
  <li><a href="#" onclick="swich_soje()">안감추가</a></li>
</ul>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#etc_pf_foto').on('click', function () {if($("#etc_pf_foto_img").attr("src")){ click_img_down($("#etc_pf_foto_img").attr("src"), '안감');}else { $('#verborgen_file_etc').click();}});
        ...
        $('#verborgen_file_etc').change(function () {
            var file = this.files[0];
            var reader = new FileReader();
            reader.onloadend = function () {
                $('#etc_pf_foto_img').attr('src', reader.result);
            }
            if (file) {
                reader.readAsDataURL(file);
            } else {
        ...
        $('.mater_select_name').change(function () {
            var mater_tel = <?php echo json_encode($mater_tel)?>;
            var idx = $(this).data("mat-sel");
            var mat_tel_input = "";
            for(var mt = 0 ; mt < mater_tel.length; mt++){
                if(mater_tel[mt]['name'] == this.value){
                    mat_tel_input = '<input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden" name="jo_mater_name_tel['+idx+']" value="'+mater_tel[mt]['tel']+'">';
                }
            }
            
            if(mat_tel_input == ''){
                mat_tel_input = '<input onfocus="Vail_fixed(this)" class="noborder txt_left print_hidden" name="jo_mater_name_tel['+idx+']" value="">';
            }
            $(".mater_tel_"+idx).empty().html(mat_tel_input);
            
            if(this.value == ''){
                $('#mater_input_name_'+idx).css("display" , "block");
                $('#mater_input_name_'+idx).attr("disabled" , false);
                // $('#mater_select_name_1').attr("disabled" , true);
            }else{
                $('#mater_input_name_'+idx).css("display" , "none");
                $('#mater_input_name_'+idx).attr("disabled" , true);
            }
        });
    ...
    function removeImg_etc(){
        $('#verborgen_file_etc').val('');
        $("input[name ='jo_etc_img_img[1]']").val('');
        $('#etc_pf_foto_img').removeAttr('src');
    }
...
<script>
    ...
    function add_mater(){
        ...
        setHtml +='<td colspan = "4" style="text-align : left;"><select class="mater_select" name="jo_mater_info_main[' + nextIdx + ']"><option value = "">선택</option><option value = "메인">메인</option><option value = "코디">코디</option><option value = "코디1">코디1</option><option value = "안감">안감</option></select>';
        setHtml +='<select class="mater_select" name="jo_mater_info_bongje[' + nextIdx + ']"><option value = "">선택</option><option value = "퀼팅">퀼팅</option><option value = "원헤드">원헤드</option><option value = "봉제">봉제</option></select>';
        setHtml +='<input onfocus="Vail_fixed(this)" class="noborder txt_left mater_input" name="jo_mater_info_title[' + nextIdx + ']" value=""></td>';
    ...
    function add_sub_mater(){
        ...
        setHtml += '<td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_sub_mater_info_yd[' + nextIdx + ']" id="jo_sub_mater_info_yd_' + nextIdx + '" data-sub-mater="' + nextIdx + '" onblur="sub_mater_math(this)"  value=""></td>';
        setHtml += '<td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder txt_right" name="jo_sub_mater_info_danga[' + nextIdx + ']" id="jo_sub_mater_info_danga_' + nextIdx + '" data-sub-mater="' + nextIdx + '" onblur="sub_mater_math(this)" value=""></td>';
    ...
    function add_gakong(){
        ...
        setHtml +='<td colspan = "4" style="text-align : left;"><select class="mater_select" name="jo_gakong_item_bongje[' + nextIdx + ']"><option value = "">선택</option><option value = "가공비_퀼팅">가공비_퀼팅</option><option value = "가공비_원헤드">가공비_원헤드</option><option value = "가공비_봉제">가공비_봉제</option></select>';
        setHtml +='<input onfocus="Vail_fixed(this)" class="noborder txt_left gakong_input" name="jo_gakong_item_title[' + nextIdx + ']" value=""></td>';

        setHtml += '<td colspan = "2"><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_size[' + nextIdx + ']" value=""></td>';
        setHtml += '<td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_hei[' + nextIdx + ']" id = "jo_gakong_item_hei_' + nextIdx + '"  value=""></td>';
        setHtml += '<td class="txt_center">x</td>';
        setHtml += '<td><input onfocus="Vail_fixed(this)" class="noborder" name="jo_gakong_item_length[' + nextIdx + ']" id = "jo_gakong_item_length_' + nextIdx + '"  value=""></td>';
    ...
    function ex_gakong_math(elem){
        ...
        // .done(function(data){
            ...
            var fileValue = $(".jo_gakong_item_price").length;
            var fileData = new Array(fileValue);
            let total_gakong_item_price = 0;
            for(var i=0; i<fileValue; i++){                          
                fileData[i] = $(".jo_gakong_item_price")[i].value.replace(/,/gi,'');
                total_gakong_item_price += (fileData[i]*1);
            }
            total_gakong_item_price = parseInt(total_gakong_item_price * 100) / 100;
            $('#total_gakong_price').val(comma(total_gakong_item_price+""));
            $('#total_gakong_price_view').empty().html(comma(total_gakong_item_price+""));
            prod_origin_price();
        // });
    ...
    function prod_origin_price(){
        ...
        //원재재금액
        let a = $('#total_mater_price').val().replace(/,/gi,'');
        //부자재
    ...
    function temp4_unim(){
        let origin = $('#jo_prod_origin_price').val().replace(/,/gi,'');
        
        let unim = $('#jo_maip_price_price_2').val().replace(/,/gi,'');

        let price = (origin*1) * ((unim*1) / 100 );
        price = Math.floor(price);

        $('#jo_maip_price_price_2_view').empty().html(comma(price+"") );

    }

    function temp4_kanse(){

        let origin = $('#jo_prod_origin_price').val().replace(/,/gi,'');
        
        let unim = $('#jo_maip_price_price_2').val().replace(/,/gi,'');

        let kanse = $('#jo_maip_price_price_3').val().replace(/,/gi,'');

        let price =  ((origin*1) +  ((origin*1) * ((unim*1) / 100 ))) * ((kanse*1) / 100) ;
        price = Math.floor(price);

        $('#jo_maip_price_price_3_view').empty().html(comma(price+"") );
    ...
    function prod_total_price(){
        ...
        let unim_price = (origin*1) * ((unim*1) / 100 );
        let kanse_price =  ((origin*1) +  (unim_price)) * ((kanse*1) / 100) ;

        

        unim_price = Math.floor(unim_price);
        kanse_price = Math.floor(kanse_price);
        $('#jo_maip_price_price_2_view').empty().html(comma(unim_price+"") );

        $('#jo_maip_price_price_3_view').empty().html(comma(kanse_price+"") );

        let rate = $('#jo_prod_control_price').val();
        
        let control_price = ((origin*1) + (unim_price*1) + (kanse_price*1))  * rate / 100 ;
        ...
        let totalprice = ((origin*1) +(unim_price*1) +(kanse_price*1) + (control_price*1) ) * 1.1 ;
    ...
    function gakong_math(elem){
        ...
        let wid = $('#jo_gakong_item_hei_'+id).val();
        ...
        let length = $('#jo_gakong_item_length_'+id).val().replace(/,/gi,'');
        let yo =((size*length)/91.44) * 1.02 ;
        
        yo = Math.ceil(yo*10)/10;
    ...
    function yochek_cal1(elem){
        ...
        let length = $('#jo_mater_info_length_'+id).val().replace(/,/gi,'');
        let price =((size*length)/91.44) * 1.02 ;
        price = parseInt(price * 100) / 100;
    ...
    function yochek_gakong(elem){
        ...
        $('#jo_gakong_item_yd_'+id).val(comma(price+""));
    ...
    function swich_soje(){
        ...
        $("#main_soje").attr('colspan' , 2);
        $("#main_soje_a").attr('colspan' , 2);

        $("#etc_soje").css('display' , '');
        $("#etc_soje_a").css('display' , '');
        $(".etc_soje").css('display' , 'block');
