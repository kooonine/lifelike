...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_content">
    	...
    	<div class="tbl_head01 tbl_wrap">
            ...
            for($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                for($k=0; $opt=sql_fetch_array($res); $k++) {
                    ...
                    $cancel_price = $cancel_price + $ct_price['stotal'];
    	...
    	/*
    	$cancel_price_send_cost = $default['de_return_costs'];
    	if($rt['cancel_select'] == "색상및사이즈변경" || $rt['cancel_select'] == "다른상품잘못주문") {
    	    $cancel_price_send_cost = 0;
    	}
    	
    	$cancel_price = $od['od_receipt_price'];
    	$tot_cancel_price = $cancel_price - $cancel_price_send_cost;*/
    	$tot_cancel_price = $cancel_price + $od['od_send_cost'] - $od['od_cart_coupon'] - $od['od_coupon'] - $od['od_send_coupon'] - $od['od_receipt_point'] -  $cancel_price_send_cost;
    	?>
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <!-- <tr>
                ...
                <div class='input-group date' id='od_hope_date_datepicker'>
                    <input type="text" name="od_hope_date" value="<?php echo $od['od_hope_date'] ?>" id="od_hope_date" class="frm_input" maxlength="10" minlength="10">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tbody>
            <tr>
                <th scope="row"><label for="mod_memo"><?php echo $change_status?> 사유입력</label></th>
                <td>
    	...
    	<div class="x_content">
    		<div class="form-group">
    			<div class="col-md-12 col-sm-12 col-xs-12 text-right">
            		...
            		<button type="submit" class="btn btn-success" id="btnConfirm"><?php echo $change_status?></button>
            	</div>
            </div>
        </div>
