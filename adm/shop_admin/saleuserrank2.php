...
<div class="x_panel">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        $headers = array('NO','성별구분','회원수', '결재완료 주문수','결재완료 상품수','결제상품 판매금액', '환불완료 상품수', '환불상품 판매금액');
        $bodys = array('NO','mb_sex_name','mb_cnt', 'cnt1','cnt3','cnt2', 'refund_cnt1', 'refund_cnt2');
        $enc = new str_encrypt();
