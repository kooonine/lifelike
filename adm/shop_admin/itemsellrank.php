...
$sql  = " select a.it_id,
                 ...
                 SUM(IF(ct_status = '주문취소',ct_qty, 0)) as ct_status_7,
...
$sql .= " where a.it_id = b.it_id and a.od_type in ('O','R','B')";
if ($fr_date && $to_date)
{
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><a href="<?php echo title_sort("ct_status_7",1)."&amp;$qstr1"; ?>">주문취소</a></th>
