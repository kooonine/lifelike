...
$g5['title'] = $fr_date.' ~ '.$to_date.' 일간 매출분석';
...
if(isset($act) && $act == "exceldownload"){
    ...
    $headers = array('NO','주문일','리스 주문수','제품 주문수','세탁 주문수','세탁보관 주문수','수선 주문수','주문수 총 합계','(총)주문금액','(총)박스비','(총)배송비','쿠폰 할인','적립금사용'
...
function print_line($save)
{
    ...
    <tr>
        ...
        <td class="td_numincome"><?php echo number_format($save['discountprice']); ?></td>
