...
$excel->setActiveSheetIndex(0)->getStyle("A2:${last_char}1")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB($header_bgcolor);
...
$excel->getActiveSheet()->fromArray($data2, NULL, 'A2');
