...
// 상품목록
$sql = " select it_id,it_name,cp_price,ct_notax,ct_send_cost,it_sc_type
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            <tr>
                ...
                <?php } ?>
                <td>
                	<input type="text" name="rf_serial[<?php echo $i ?>]" id="rf_serial_<?php echo $i ?>" class="form-control" value="<?php echo $opt['rf_serial']; ?>" >
				</td>
                <td class="td_itname">
